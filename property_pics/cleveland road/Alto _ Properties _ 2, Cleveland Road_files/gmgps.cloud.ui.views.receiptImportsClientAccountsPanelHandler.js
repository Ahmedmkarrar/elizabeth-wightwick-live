((function() {
    gmgps.cloud.ui.views.receiptImportsClientAccountsPanelHandler =
        ReceiptImportsClientAccountPanelHandler;

    function ReceiptImportsClientAccountPanelHandler(args) {
        var me = this;
        me.$root = args.$root;
        me.http = args.http || new gmgps.cloud.http('receiptImportsClientAccountsPanelHandler-ReceiptImportsClientAccountPanelHandler');
        me.url = args.url;
        ...
        if (
        // eslint-disable-next-line no-prototype-builtins
            args.hasOwnProperty('getSortOrder') &&
            args.getSortOrder instanceof Function
        ) {
        ...
        if (
        // eslint-disable-next-line no-prototype-builtins
            args.hasOwnProperty('refresh') &&
            args.refresh instanceof Function
        ) {
    ...
    gmgps.cloud.ui.views.receiptImportsClientAccountsPanelHandler.prototype = {
        sortOrderType: C.ReceiptImportsAccountCentreSortOrderType,
        ...
        initEvents: function () {
            var me = this,
                namespace = '.ImportReceiptsClientAccountPanelHandler';
        ...
        getSortOrder: function () {
            ...
            switch (parseInt(me.sortOrder)) {
                ...
                case me.sortOrderType['AccountNumber']:
                    ...
                    break;
                case me.sortOrderType['LastImport']:
                    orderDescending = true;
                    dataAttribute = 'lastimport';
                    break;
                case me.sortOrderType['UnMatchedItems']:
                    dataAttribute = 'unmatched';
                    break;
            }
            return {
