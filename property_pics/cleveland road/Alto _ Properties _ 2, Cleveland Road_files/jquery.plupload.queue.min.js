    ...
    e.fn.pluploadQueue = function (s) {
        return s
            ? (this.each(function () {
                  function c(t) {
                      ...
                      t.status == plupload.DONE && (n = 'plupload_done'),
                          t.status == plupload.FAILED &&
                              (n = 'plupload_failed'),
                          t.status == plupload.QUEUED &&
                              (n = 'plupload_delete'),
                          t.status == plupload.UPLOADING &&
                  ...
                  function h() {
                      e('span.plupload_total_status', a).html(
                          u.total.percent + '%'
                      ),
                          e('div.plupload_progress_bar', a).css(
                              'width',
                              u.total.percent + '%'
                          ),
                          e('span.plupload_upload_status', a).html(
                              t.sprintf(
                  ...
                  function p() {
                      ...
                      e.each(u.files, function (t, r) {
                          (s = ''),
                              r.status == plupload.DONE &&
                                  (r.target_name &&
                                      (s +=
                                          ...
                                          i +
                                          '_tmpname" value="' +
                                          plupload.xmlEncode(r.target_name) +
                                          '" />'),
                                  (s +=
                                      '<input type="hidden" name="' +
                                      f +
                              ...
                              c(r),
                              e('#' + r.id + '.plupload_delete a').click(
                                  function (t) {
                                      e('#' + r.id).remove(),
                                          u.removeFile(r),
                                          t.preventDefault();
                          ...
                          e('span.plupload_total_file_size', a).html(
                              plupload.formatSize(u.total.size)
                          ),
                          u.total.queued === 0
                              ? e('span.plupload_add_text', a).html(
                                    r('Add Files')
                                )
                              : e('span.plupload_add_text', a).html(
                                    t.sprintf(
                          ...
                          e('a.plupload_start', a).toggleClass(
                              'plupload_disabled',
                              u.files.length ==
                                  u.total.uploaded + u.total.failed
                          ),
                  ...
                  (a = e(this)),
                      ...
                      s.dragdrop && (s.drop_element = f + '_filelist'),
                      (u = new plupload.Uploader(s)),
                      (n[f] = u),
                      ...
                      u.bind('Init', function (t, n) {
                          !s.unique_names &&
                              ...
                              e('a.plupload_start', a).click(function (t) {
                                  e(this).hasClass('plupload_disabled') ||
                                      u.start(),
                                      t.preventDefault();
                              }),
                      ...
                      u.bind('Error', function (t, n) {
                          ...
                          i &&
                              ((s = n.message),
                              n.details && (s += ' (' + n.details + ')'),
                              n.code == plupload.FILE_SIZE_ERROR &&
                                  alert(
                                      r('Error: File too large:') + ' ' + i.name
                                  ),
                      ...
                      u.bind('UploadProgress', function (t, n) {
                          e('#' + n.id + ' div.plupload_file_status', a).html(
                              n.percent + '%'
                          ),
                              c(n),
                              h();
