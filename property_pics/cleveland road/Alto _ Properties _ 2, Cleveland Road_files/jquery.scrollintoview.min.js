...
(function (f) {
    ...
    var g = function (k, j) {
        ...
        var h = {
            top:
                parseFloat(i ? j.borderTopWidth : f.css(k, 'borderTopWidth')) ||
                0,
            left:
                parseFloat(
                    i ? j.borderLeftWidth : f.css(k, 'borderLeftWidth')
                ) || 0,
            bottom:
                parseFloat(
                    i ? j.borderBottomWidth : f.css(k, 'borderBottomWidth')
                ) || 0,
            right:
                parseFloat(
                    i ? j.borderRightWidth : f.css(k, 'borderRightWidth')
                ) || 0
        };
        return {
            top: h.top,
    ...
    f.fn.extend({
        scrollintoview: function (j) {
            ...
            j.direction =
                c[
                    typeof j.direction === 'string' && j.direction.toLowerCase()
                ] || c.both;
            var n = '';
                ...
                if (j.direction.y === true) {
                    if (h.top < 0) {
                        ...
                        if (h.top > 0 && h.bottom < 0) {
                            k.scrollTop =
                                m.s.scroll.top + Math.min(h.top, -h.bottom);
                        }
                    }
                }
                if (j.direction.x === true) {
                    if (h.left < 0) {
                        ...
                        if (h.left > 0 && h.right < 0) {
                            k.scrollLeft =
                                m.s.scroll.left + Math.min(h.left, -h.right);
                        }
                    }
                }
