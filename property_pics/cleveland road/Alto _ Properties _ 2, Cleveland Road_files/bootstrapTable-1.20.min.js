...
!(function (t, e) {
    ...
    var T,
        ...
        ht = ct && ct.v8;
    ht && (P = (T = ht.split('.'))[0] > 0 && T[0] < 4 ? 1 : +(T[0] + T[1])),
        !P &&
            rt &&
            (!(T = rt.match(/Edge\/(\d+)/)) || T[1] >= 74) &&
            (T = rt.match(/Chrome\/(\d+)/)) &&
            (P = +T[1]);
    var ut = P,
        dt = ut,
        ...
        Dt = function (t, e) {
            try {
                Nt(_t, t, { value: e, configurable: !0, writable: !0 });
            } catch (i) {
                _t[t] = e;
            }
            return e;
    ...
    var Mt = W,
        ...
        Qt = function (t) {
            return (
                'Symbol(' + (void 0 === t ? '' : t) + ')_' + Xt(++Yt + Jt, 36)
            );
        },
        Zt = p,
        te = Ft.exports,
        ...
        pe = function (t, e) {
            var i, n;
            if ('string' === e && Rt((i = t.toString)) && !Et((n = $t(i, t))))
                return n;
            ...
            ? function (t, e, i) {
                  if (
                      ...
                      n &&
                          ...
                          (i = {
                              configurable:
                                  Ze in i ? i.configurable : n.configurable,
    ...
    var zi = {
            ...
            getterFor: function (t) {
                return function (e) {
                    var i;
                    if (!$i(e) || (i = gi(e)).type !== t)
                        throw Di('Incompatible receiver, ' + t + ' required');
                    return i;
                };
            }
        },
        ...
        ho = function (t, e) {
            ...
            if ((i = l ? no : c ? no[s] || so(s, {}) : (no[s] || {}).prototype))
                for (n in e) {
                    if (
                        ((a = e[n]),
                        (o = t.noTargetGet ? (r = oo(i, n)) && r.value : i[n]),
    ...
    var $o = '[object z]' === String(Ao),
        ...
        Jo = { start: Yo(1), end: Yo(2), trim: Yo(3) },
        Xo = hi.PROPER,
        Qo = v,
        Zo = Mo,
        ta = Jo.trim;
    ...
    var ea = v,
        ...
        ca = ra('join', ',');
    na(
        { target: 'Array', proto: !0, forced: la || !ca },
        {
            join: function (t) {
    ...
    ba.f =
        ma && !ya
            ...
            : function (t, e) {
                  Sa(t);
                  for (
                      var i, n = xa(e), o = ka(e), a = o.length, r = 0;
                      a > r;
    ...
    var Oa,
        Ca = it('document', 'documentElement'),
        Ta = Ue,
        Pa = ba,
        Ia = Fn,
        Aa = Ti,
        ...
        Na = function () {
            ...
            Na =
                'undefined' != typeof document
                    ? document.domain && Oa
                        ? _a(Oa)
                        : (((e = Ra('iframe')).style.display = 'none'),
                          $a.appendChild(e),
                          (e.src = String('javascript:')),
                          (t = e.contentWindow.document).open(),
                          t.write(Fa('document.F=Object')),
                          t.close(),
                          t.F)
                    : _a(Oa);
            ...
            if (
                (f &&
                    ...
                    l.lastIndex > 0 &&
                        ...
                        ((g = '(?: ' + g + ')'), (b = ' ' + b), v++),
                    (i = new RegExp('^(?:' + g + ')', p))),
                cr && (i = new RegExp('^' + g + '$(?!\\s)', p)),
                sr && (n = l.lastIndex),
                (o = za(er, f ? i : l, b)),
                f
                    ? o
                        ? ((o.input = rr(o.input, v)),
                          (o[0] = rr(o[0], v)),
                          (o.index = l.lastIndex),
                ...
                cr &&
                    o &&
                    o.length > 1 &&
                    za(tr, o[0], i, function () {
                        for (a = 1; a < arguments.length - 2; a++)
                            void 0 === arguments[a] && (o[a] = void 0);
                    }),
                o && d)
            )
                for (o.groups = r = Ja(null), a = 0; a < d.length; a++)
                    r[(s = d[a])[0]] = o[s[1]];
            return o;
        });
    var hr = ir;
    ho({ target: 'RegExp', proto: !0, forced: /./.exec !== hr }, { exec: hr });
    var ur = m,
                    ...
                    function (t, o) {
                        ...
                        for (var f = 0, p = 0, g = []; p < r.length; ) {
                            ...
                            if (
                                null === b ||
                                (v = Ls(
                                    Rs(u.lastIndex + (Vs ? p : 0)),
                                    r.length
                                )) === f
                            )
                                p = $s(r, p, c);
                            else {
                                if ((Us(g, zs(r, f, p)), g.length === d))
                                    return g;
    ...
    var Ws = b,
        ...
        Qs = function (t) {
            return function (e) {
                for (
                    var i, n = Ys(e), o = Ks(n), a = o.length, r = 0, s = [];
                    a > r;
    ...
    var tl = Da,
        ...
        il = ce('unscopables'),
        nl = Array.prototype;
    null == nl[il] && el.f(nl, il, { configurable: !0, value: tl(null) });
    var ol = function (t) {
            nl[il][t] = !0;
        },
        al = Pn.includes,
    ...
    Sl(
        { target: 'Array', proto: !0, arity: 1, forced: !Nl || !Dl },
        {
            concat: function (t) {
                var e,
                    i,
    ...
    $o || cn(Object.prototype, 'toString', ic, { unsafe: !0 });
    var nc = Ir,
        oc = p.TypeError,
        ac = function (t) {
            if (nc(t))
    ...
    var Mc = ps,
        ...
        zc = function (t, e) {
            ...
            return i < 8
                ? qc(t, e)
                : Wc(t, zc(Mc(t, 0, n), e), zc(Mc(t, n), e), e);
        },
        qc = function (t, e) {
        ...
        mh = !ah(function () {
            ...
            if (!(lh && lh > 3)) {
                ...
                for (t = 65; t < 76; t++) {
                    ...
                    for (n = 0; n < 47; n++) dh.push({ k: e + n, v: i });
                }
                for (
    ...
    Zc(
        { target: 'Array', proto: !0, forced: gh || !vh || !bh || !mh },
        {
            sort: function (t) {
                void 0 !== t && eh(t);
                var e = ih(this);
            ...
            return [
                ...
                function (t, o) {
                    ...
                    for (var u = []; ; ) {
                        ...
                        if ((Wh(u, d), !c)) break;
                        '' === Nh(d[0]) &&
                            (a.lastIndex = Vh(r, _h(a.lastIndex), h));
                    }
                    for (var f, p = '', g = 0, v = 0; v < u.length; v++) {
                        for (
                            var b = Nh((d = u[v])[0]),
                                m = Uh(zh(Fh(d.index), r.length), 0),
                                y = [],
                                w = 1;
                            w < d.length;
                            w++
                        )
                            Wh(y, void 0 === (f = d[w]) ? f : String(f));
                        var S = d.groups;
                        if (l) {
                            var x = qh([b], y, m, r);
                            void 0 !== S && Wh(x, S);
    ...
    var Xh = Yl.filter;
    ho(
        { target: 'Array', proto: !0, forced: !wl('filter') },
        {
            filter: function (t) {
                return Xh(
                    this,
    ...
    Or('search', function (t, e, i) {
        return [
            ...
            function (t) {
                ...
                var s = au(n, o);
                return (
                    iu(n.lastIndex, r) || (n.lastIndex = r),
                    null === s ? -1 : s.index
                );
            }
        ];
    ...
    var ru = p,
        ...
        bu =
            ...
            (pu &&
                ...
                : du;
    ho({ global: !0, forced: parseInt != bu }, { parseInt: bu });
    var mu = Yl.map;
    ho(
        { target: 'Array', proto: !0, forced: !wl('map') },
        {
            map: function (t) {
                return mu(
                    this,
    ...
    var Ou = p,
        ...
        Ru =
            ...
            ('__proto__' in {}
                ? (function () {
                      ...
                      return function (i, n) {
                          return (
                              Au(i), $u(n), e ? t(i, n) : (i.__proto__ = n), i
                          );
                      };
                  })()
                : void 0),
        ...
        Hu = function (t) {
            var e = t.flags;
            return void 0 !== e || 'flags' in Lu || Du(t, 'flags') || !Vu(Lu, t)
                ? e
                : Nu(Bu, t);
        },
        Mu = De.f,
    ...
    var Md = F([].slice),
        ...
        of = Math.max;
    Ud(
        { target: 'Array', proto: !0, forced: !tf },
        {
            slice: function (t, e) {
                var i,
                    n,
                ...
                if (
                    ...
                    return Zd(a, s, l);
                for (
                    n = new (void 0 === i ? nf : i)(of(l - s, 0)), o = 0;
                    s < l;
                    s++, o++
                )
                    s in a && Xd(n, o, a[s]);
    ...
    [].keys &&
        ('next' in (sf = [].keys())
            ? (rf = Sf(Sf(sf))) !== Object.prototype && (af = rf)
            : (Of = !0));
    var Cf =
        null == af ||
        yf(function () {
    ...
    var Tf = { IteratorPrototype: af, BUGGY_SAFARI_ITERATORS: Of },
        Pf = De.f,
        If = Gt,
        Af = ce('toStringTag'),
        $f = function (t, e, i) {
            t && !i && (t = t.prototype),
                t && !If(t, Af) && Pf(t, Af, { configurable: !0, value: e });
        },
        ...
        sp = function (t, e, i, n, o, a, r) {
            ...
            if (
                (v &&
                    (s = Hf(v.call(new t()))) !== Object.prototype &&
                    s.next &&
                    (Hf(s) !== Yf &&
                        (Mf ? Mf(s, Yf) : Bf(s[Xf]) || qf(s, Xf, ep)),
                    Uf(s, u, !0)),
                Gf &&
                    o == Zf &&
                    p &&
                ...
                else Df({ target: e, proto: !0, forced: Jf || d }, l);
            return f[Xf] !== g && qf(f, Xf, g, { name: o }), (Wf[e] = g), l;
        },
        lp = b,
        cp = 'Array Iterator',
        hp = ap.set,
        ...
        dp = sp(
            ...
            'Array',
            function (t, e) {
                hp(this, { type: cp, target: ip(t), index: 0, kind: e });
            },
            function () {
                var t = up(this),
                    e = t.target,
            ...
            splice: function (t, e) {
                ...
                if (
                    (0 === u
                        ...
                        : 1 === u
                        ? ((i = 0), (n = c - h))
                        : ((i = u - 2), (n = Np(_p(Ip(e), 0), c - h))),
                    c + i - n > Dp)
                )
                    throw Fp(Vp);
                for (o = Rp(l, n), a = 0; a < n; a++)
                    (r = h + a) in l && Ep(o, a, l[r]);
                if (((o.length = n), i < n)) {
                    for (a = h; a < c - n; a++)
                        (s = a + i),
                            (r = a + n) in l ? (l[s] = l[r]) : delete l[s];
                    for (a = c; a > c - n + i; a--) delete l[a - 1];
                } else if (i > n)
                    for (a = c - n; a > h; a--)
                        (s = a + i - 1),
                            (r = a + n - 1) in l ? (l[s] = l[r]) : delete l[s];
        ...
        return [
            ...
            function (t) {
                ...
                for (var s, l = [], c = 0; null !== (s = Pg(n, o)); ) {
                    var h = kg(s[0]);
                    (l[c] = h),
                        '' === h && (n.lastIndex = Tg(o, xg(n.lastIndex), r)),
                        c++;
                }
                return 0 === c ? null : l;
            }
    ...
    Ag(
        {
            ...
            forced:
                !!(
                    Lg ||
                    ((Ig = Rg(String.prototype, 'startsWith')),
                    !Ig || Ig.writable)
                ) && !Lg
        },
        {
    ...
    Hg(
        { target: 'String', proto: !0, forced: !Zg && !Qg },
        {
            endsWith: function (t) {
                var e = qg(Gg(this));
                Wg(t);
            ...
            return (
                r(t, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.constants.buttonsClass = [
                                t.buttonsPrefix,
                                a + t.buttonsClass,
                                tv.sprintf(''.concat(a, '%s'), t.iconSize)
                            ]
                                .join(' ')
                                .trim()),
                                (this.buttons = tv.calculateObjectValue(
                                    this,
                                    t.buttons,
                                    [],
                                    {}
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                tv.setFieldIndex(this.options.columns),
                        ...
                        value: function () {
                            ...
                            (this.header = {
                                ...
                                this.options.columns.forEach(function (i, o) {
                                    ...
                                    if (
                                        0 === o &&
                                        tv.hasDetailViewIcon(t.options)
                                    ) {
                                        var l =
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            'append' === e
                                ...
                                : ((t = t || tv.deepCopy(this.options.data)),
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                if (this.options.customSearch)
                                    return (
                                        (this.data = tv.calculateObjectValue(
                                            this.options,
                                ...
                                var e =
                                        this.searchText &&
                                        (this.fromHtml
                                            ? tv.escapeHTML(this.searchText)
                                            : this.searchText),
                                    i = e ? e.toLowerCase() : '',
                                    n = tv.isEmptyObject(this.filterColumns)
                                        ? null
                                        : this.filterColumns;
                                this.options.searchAccentNeutralise &&
                                    (i = tv.normalizeAccent(i)),
                                    'function' ==
                    ...
                    },
                    {
                        ...
                        value: function (t, e, i, o) {
                            ...
                            if (!(tv.findIndex(this.hiddenRows, t) > -1)) {
                                ...
                                var I = '';
                                return (
                                    tv.hasDetailViewIcon(this.options) &&
                                        ((I = '<td>'),
                                        tv.calculateObjectValue(
                                            null,
                                            this.options.detailFilter,
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            var a = [],
                                ...
                                s = !1,
                                l = [];
                            this.autoMergeCells = tv.checkAutoMergeCells(
                    ...
                    },
                    {
                        key: 'refreshOptions',
                        value: function (t) {
                            tv.compareObjects(this.options, t, !0) ||
                        ...
                        value: function (t) {
                            ...
                            if (
                                ((!(
                                    ...
                                    tv.isEmptyObject(this.filterColumns) &&
                                    'function' !=
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            for (
                                ...
                                if (
                                    (i = this.options.data[e]).hasOwnProperty(o)
                                )
                                    n = i[o];
                                else {
                    ...
                    },
                    {
                        key: 'filterBy',
                        value: function (t, e) {
                            (this.filterOptions = tv.isEmptyObject(e)
                                ? this.options.filterOptions
                                : i.default.extend(
                                      this.options.filterOptions,
                                      e
                                  )),
                                (this.filterColumns = tv.isEmptyObject(t)
                                    ? {}
                                    : t),
                                (this.options.pageNumber = 1),
                                this.initSearch(),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            this.$body
                                .find(tv.sprintf('> tr[data-index="%s"]', t))
                                .next()
                                .is('tr.detail-view')
                                ? this.collapseRow(t)
                                : this.expandRow(t, e),
    ...
    return (
        ...
        (lv.DEFAULTS = rv.DEFAULTS),
        (lv.LOCALES = rv.LOCALES),
        (lv.COLUMN_DEFAULTS = rv.COLUMN_DEFAULTS),
        (lv.METHODS = rv.METHODS),
        (lv.EVENTS = rv.EVENTS),
        (i.default.BootstrapTable = lv),
        ...
        (i.default.fn.bootstrapTable.Constructor = lv),
        (i.default.fn.bootstrapTable.theme = rv.THEME),
        (i.default.fn.bootstrapTable.VERSION = rv.VERSION),
        (i.default.fn.bootstrapTable.defaults = lv.DEFAULTS),
        (i.default.fn.bootstrapTable.columnDefaults = lv.COLUMN_DEFAULTS),
        (i.default.fn.bootstrapTable.events = lv.EVENTS),
        (i.default.fn.bootstrapTable.locales = lv.LOCALES),
        (i.default.fn.bootstrapTable.methods = lv.METHODS),
        (i.default.fn.bootstrapTable.utils = tv),
        i.default(function () {
