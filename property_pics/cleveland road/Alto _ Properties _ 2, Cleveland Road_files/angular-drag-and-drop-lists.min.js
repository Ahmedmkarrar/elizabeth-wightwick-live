            ...
            return function (l, f, c) {
                f.attr('draggable', 'true'),
                    ...
                    f.on('dragstart', function (s) {
                        if (
                            ((s = s.originalEvent || s),
                            'false' == f.attr('draggable'))
                        )
                            return !0;
                        (o.isDragging = !0),
                            (o.itemType =
                                c.dndType && l.$eval(c.dndType).toLowerCase()),
                            (o.dropEffect = 'none'),
                        ...
                        if (
                            ...
                            s._dndHandle &&
                                ...
                                s.dataTransfer.setDragImage(f[0], 0, 0),
                            e(c.dndDragstart)(l, { event: s }),
                            c.dndCallback)
                        ) {
                ...
                return function (i, l, f) {
                    ...
                    function s(e) {
                        return o.isDragging
                            ...
                            : e == t || e == r
                            ? null
                            : (e && e.substr(a.length + 1)) || void 0;
                    }
                    function g(e) {
                        return E.disabled
                            ? !1
                            : E.externalSources || o.isDragging
                            ? E.allowedTypes && null !== e
                                ? e && -1 != E.allowedTypes.indexOf(e)
                                : !0
                            : !1;
                    }
                    function u(e, a) {
                        var r = d;
                        return (
                            a || (r = n(r, e.dataTransfer.effectAllowed)),
                            o.isDragging && (r = n(r, o.effectAllowed)),
                            f.dndEffectAllowed &&
                                (r = n(r, f.dndEffectAllowed)),
                            r.length
                    ...
                    function y() {
                        var e;
                        return (
                            angular.forEach(l.children(), function (n) {
                    ...
                    l.on('dragenter', function (e) {
                        ...
                        E = {
                            ...
                            externalSources:
                                f.dndExternalSources &&
                                i.$eval(f.dndExternalSources),
                            horizontal:
                                f.dndHorizontalList &&
                                i.$eval(f.dndHorizontalList)
                        };
                        ...
                        l.on('dragover', function (e) {
                            ...
                            if (!n || !g(a)) return !0;
                            if (
                                (h.parentNode != m && l.append(T),
                                e.target != m)
                            ) {
                                for (
                                    var r = e.target;
                                    r.parentNode != m && r.parentNode;
                                ...
                                if (r.parentNode == m && r != h) {
                                    ...
                                    if (E.horizontal)
                                        var o =
                                            e.clientX < d.left + d.width / 2;
                                    else
                                        var o =
                                            e.clientY < d.top + d.height / 2;
                            ...
                            return 'none' == D
                                ? p()
                                : f.dndDragover && !v(f.dndDragover, e, D, a)
                                ? p()
                                : (e.preventDefault(),
                                  i || (e.dataTransfer.dropEffect = D),
                                  l.addClass('dndDragover'),
                                  e.stopPropagation(),
                                  !1);
                        }),
                        l.on('drop', function (e) {
                            ...
                            var h = D();
                            return f.dndDrop &&
                                ((d = v(f.dndDrop, e, T, a, h, d)), !d)
                                ? p()
                                : ((o.dropEffect = T),
                                  y || (e.dataTransfer.dropEffect = T),
                                  d !== !0 &&
                                      i.$apply(function () {
                                          i.$eval(f.dndList).splice(h, 0, d);
                                      }),
                                  v(f.dndInserted, e, T, a, h, d),
                                  p(),
                                  e.stopPropagation(),
                                  !1);
                        }),
            ...
            return function (e, n, a) {
                n.attr('draggable', 'true'),
                    ...
                    n.on('dragend', function (e) {
                        (e = e.originalEvent || e),
                            e._dndHandle || e.stopPropagation();
                    });
            };
        }),
