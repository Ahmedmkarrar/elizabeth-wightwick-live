...
!(function (a) {
    ...
    (a.create = function () {
        ...
        (b.prototype = {
            init: function () {
                ...
                this.$element.addClass('hidden'),
                    ...
                    this.options.offLabel &&
                        this.$off[b](this.options.offLabel),
            ...
            click: function (b) {
                ...
                (c.hasClass('active') && !this.options.switchAlways) ||
                    this.change();
            },
            change: function () {
            ...
            keydown: function (b) {
                -1 != a.inArray(b.keyCode, this.options.toggleKeyCodes)
                    ? (b.preventDefault(), this.change())
                    : 13 == b.keyCode && a(this.element.form).trigger('submit');
            },
            reset: function () {
                ((this.element.defaultChecked &&
                    this.$off.hasClass('active')) ||
                    (!this.element.defaultChecked &&
                        this.$on.hasClass('active'))) &&
    ...
    return (
        (a.fn.checkboxpicker = function (c, d) {
            ...
            return (
                (e =
                    this instanceof a ? this : a('string' == typeof c ? c : d)),
                e.each(function () {
