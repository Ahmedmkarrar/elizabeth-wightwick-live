            ...
            function j(a, b, c, d) {
                ...
                return (
                    ...
                    (k.add = function (c) {
                        var d = e(c);
                        return (
                            a.replaceSpacesWithDashes &&
                                (d = i.replaceSpacesWithDashes(d)),
                            f(c, d),
                            h(c)
                                .then(function () {
                                    k.items.push(c),
                                        b.trigger('tag-added', { $tag: c });
                                })
                                ['catch'](function () {
                ...
                link: function (b, c, g, h) {
                    ...
                    (j = function () {
                        h.$setValidity('maxTags', m.items.length <= o.maxTags),
                            h.$setValidity(
                                'minTags',
                                m.items.length >= o.minTags
                            ),
                            h.$setValidity(
                                'leftoverText',
                                b.hasFocus || o.allowLeftoverText
                                    ? !0
                                    : !b.newTag.text()
                            );
                    }),
            ...
            function (b, c, d, e, f, g) {
                function h(a, b, c) {
                    ...
                    return (
                        (h = function () {
                            return (
                                b.tagsInput.keyProperty ||
                                b.tagsInput.displayProperty
                            );
                        }),
                        (d = function (a, c) {
                            return a.filter(function (a) {
                                return !g.findInObjectArray(
                                    c,
                                    a,
                                    h(),
                                    function (a, c) {
                    ...
                    link: function (b, c, d, e) {
                        ...
                        (l.tagsInput = k.getOptions()),
                            ...
                            (b.addSuggestion = function () {
                                ...
                                return (
                                    j.selected &&
                                        (k.addTag(angular.copy(j.selected)),
                                        j.reset(),
                                        (a = !0)),
                                    a
                                );
                            ...
                            (b.track = function (a) {
                                return a[
                                    l.tagsInput.keyProperty ||
                                        l.tagsInput.displayProperty
                                ];
                            }),
                    ...
                    (c.simplePubSub = function () {
                        ...
                        return {
                            ...
                            trigger: function (b, d) {
                                ...
                                return (
                                    e.every(function (a) {
                                        return c.handleUndefinedResult(
                                            a,
                                            !0
                                        )(d);
                                    }),
