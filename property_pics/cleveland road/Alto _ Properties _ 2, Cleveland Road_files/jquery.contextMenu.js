        ...
        defaults = {
            ...
            position: function (opt, x, y) {
                ...
                if (!x && !y) {
                    ...
                    var triggerIsFixed = opt.$trigger
                        .parents()
                        .andSelf()
                        .filter(function () {
        ...
        handle = {
            ...
            itemClick: function (e) {
                ...
                if (
                    !opt.items[key] ||
                    $this.hasClass('disabled') ||
                    $this.hasClass('context-menu-submenu')
                ) {
                    return;
                }
        ...
        op = {
            ...
            hide: function (opt, force) {
                ...
                if (
                    !force &&
                    opt.events &&
                    opt.events.hide.call($this, opt) === false
                ) {
                    return;
                }
                ...
                $.each(opt.items, function (key, item) {
                    ...
                    if (typeof item == 'string') {
                        ...
                        switch (item.type) {
                            case 'text':
                                $input = $(
                                    '<input type="text" value="1" name="context-menu-input-' +
                                        key +
                                        '" value="">'
                                )
                                    .val(item.value || '')
                            ...
                            case 'textarea':
                                $input = $(
                                    '<textarea name="context-menu-input-' +
                                        key +
                                        '"></textarea>'
                                )
                                    .val(item.value || '')
                            ...
                            case 'checkbox':
                                $input = $(
                                    '<input type="checkbox" value="1" name="context-menu-input-' +
                                        key +
                                        '" value="">'
                                )
                                    .val(item.value || '')
                            ...
                            case 'radio':
                                $input = $(
                                    '<input type="radio" value="1" name="context-menu-input-' +
                                        item.radio +
                                        '" value="">'
                                )
                                    .val(item.value || '')
                            ...
                            case 'select':
                                $input = $(
                                    '<select name="context-menu-input-' +
                                        key +
                                        '">'
                                ).appendTo($label);
                                if (item.options) {
                ...
                if (root === undefined) {
                    ...
                    opt.$menu
                        ...
                        .each(function () {
                            ...
                            $this
                                .width(
                                    $this.css('position', 'absolute').width()
                                )
                                .css('position', 'static');
                        })
                    ...
                    var $item = $(this),
                        ...
                        disabled =
                            ($.isFunction(item.disabled) &&
                                item.disabled.call($this, key, root)) ||
                            item.disabled === true;
