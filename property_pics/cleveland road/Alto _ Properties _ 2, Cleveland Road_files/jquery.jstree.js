    ...
    (function ($) {
        ...
        $.fn.jstree = function (settings) {
            ...
            if (isMethodCall) {
                ...
                this.each(function () {
                    var instance =
                            instances[$.data(this, 'jstree-instance-id')],
                        methodValue =
                ...
                this.each(function () {
                    ...
                    b = a.length
                        ? $.extend.apply(null, [true, b].concat(a))
                        : b;
        ...
        $.jstree = {
            ...
            _reference: function (needle) {
                ...
                return (
                    instances[
                        o.closest('.jstree').data('jstree-instance-id')
                    ] || null
                );
            },
        ...
        $(function () {
            ...
            var u = navigator.userAgent.toLowerCase(),
                ...
                css_string =
                    ...
                    '.jstree a { display:inline-block; line-height:16px; height:16px; color:#777777; white-space:nowrap; text-decoration:none; padding: 1px 2px; margin:0; } ' +
                    '.jstree a:focus { outline: none; } ' +
                    '.jstree a:hover { color: #444; } ' +
                    '.jstree a > ins { height:16px; width:16px; } ' +
                    '.jstree a > .jstree-icon { margin-right:3px; } ' +
                    '.jstree-rtl a > .jstree-icon { margin-left:3px; margin-right:0; } ' +
                    'li.jstree-open > ul { display:block; margin-top: 3px; margin-bottom: 3px; } ' +
        ...
        $.jstree.plugin('core', {
            ...
            _fn: {
                ...
                correct_state: function (obj) {
                    ...
                    obj.removeClass('jstree-closed jstree-open')
                ...
                open_node: function (obj, callback, skip_animation) {
                    ...
                    if (!this._is_loaded(obj)) {
                        ...
                        if (this._get_settings().core.open_parents) {
                            obj.parentsUntil('.jstree', '.jstree-closed').each(
                                function () {
                ...
                create_node: function (obj, position, js, callback, is_loaded) {
                    obj = this._get_node(obj);
                    position =
                        typeof position === 'undefined' ? 'last' : position;
                    var d = $('<li />'),
                    ...
                    $.each(js.data, function (i, m) {
                        ...
                        if (typeof m == 'string') {
                            ...
                            tmp.attr(m.attr)[s.html_titles ? 'html' : 'text'](
                                m.title
                            );
                            if (m.language) {
                    ...
                    if (
                        tmp === -1 ||
                        tmp.get(0) === this.get_container().get(0)
                    ) {
                        tmp = -1;
                    }
                    this.clean_node(tmp);
                ...
                prepare_move: function (o, r, pos, cb, is_cb) {
                    ...
                    p.p =
                        typeof pos === 'undefined' || pos === false
                            ? 'last'
        ...
        $.jstree.plugin('themes', {
            ...
            _fn: {
                set_theme: function (theme_name, theme_url) {
                    ...
                    if (!theme_url) {
                        theme_url =
                            $.jstree._themes + theme_name + '/style.css?3';
                    }
        ...
        $.jstree.plugin('checkbox', {
            __init: function () {
                this.data.checkbox.noui =
                    this._get_settings().checkbox.override_ui;
                ...
                this.get_container()
                    ...
                    .on(
                        ...
                        this.data.ui && this.data.checkbox.noui
                            ? 'a'
                            : 'ins.jstree-checkbox, a',
                        $.proxy(function (e) {
                            e.preventDefault();
                            if (
                                this._get_node(e.target).hasClass(
                                    'jstree-checked'
                                )
                            ) {
            ...
            defaults: {
                ...
                real_checkboxes_names: function (n) {
                    return [
                        'check_' +
                            (n[0].id || Math.ceil(Math.random() * 10000)),
                        1
                    ];
                }
            },
            ...
            _fn: {
                ...
                _prepare_checkboxes: function (obj) {
                    ...
                    var c,
                        ...
                        rcn =
                            this._get_settings().checkbox.real_checkboxes_names;
                    obj.each(function () {
                        t = $(this);
                        c =
                            t.is('li') &&
                            ...
                            .each(function () {
                                ...
                                if (rc) {
                                    if (!$t.children(':checkbox').length) {
                                        ...
                                        $t.children(':checkbox').addClass(
                                            'jstree-real-checkbox'
                                        );
                                    }
                                    if (c === 'jstree-checked') {
                                        $t.children(':checkbox').attr(
                                            'checked',
                                            'checked'
                                        );
                                    }
                ...
                change_state: function (obj, state) {
                    ...
                    if (this._get_settings().checkbox.two_state) {
                        if (state) {
                            obj.removeClass('jstree-checked').addClass(
                                'jstree-unchecked'
                            );
                            if (rc) {
                            ...
                            obj.removeClass('jstree-unchecked').addClass(
                                'jstree-checked'
                            );
                            if (rc) {
                                obj.children(':checkbox').attr(
                                    'checked',
                                    'checked'
                                );
                            }
                        ...
                        if (state) {
                            ...
                            if (rc) {
                                coll.children(':checkbox').removeAttr(
                                    'checked'
                                );
                            }
                        } else {
                            ...
                            if (state) {
                                if (
                                    $this
                                        .children('ul')
                                        .children(
                                            'li.jstree-checked, li.jstree-undetermined'
                                        ).length
                                ) {
                                    $this
                                        .parentsUntil('.jstree', 'li')
                                ...
                                if (
                                    $this
                                        .children('ul')
                                        .children(
                                            'li.jstree-unchecked, li.jstree-undetermined'
                                        ).length
                                ) {
                                    $this
                                        .parentsUntil('.jstree', 'li')
                ...
                _is_loaded: function (obj) {
                    ...
                    return (
                        ...
                        (!this._get_settings().html_data.ajax &&
                            !$.isFunction(
                                this._get_settings().html_data.data
                            )) ||
                    ...
                    switch (!0) {
                        ...
                        case (!s.data && !!s.ajax) ||
                            ...
                            error_func = function (x, t, e) {
                                var ef =
                                    this.get_settings().html_data.ajax.error;
                                if (ef) {
                                    ef.call(this, x, t, e);
                                }
                                if (obj != -1 && obj.length) {
                            ...
                            success_func = function (d, t, x) {
                                var sf =
                                    this.get_settings().html_data.ajax.success;
                                if (sf) {
