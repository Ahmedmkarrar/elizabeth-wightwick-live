...
(function () {
    ...
    $P.between = function (start, end) {
        return (
            this.getTime() >= start.getTime() && this.getTime() <= end.getTime()
        );
    };
...
(function () {
    ...
    var dx = 'sunday monday tuesday wednesday thursday friday saturday'.split(
        ...
        pxf =
            'Milliseconds Seconds Minutes Hours Date Week Month FullYear'.split(
                /\s/
            ),
...
(function () {
    ...
    $D.Translator = {
        ...
        finish: function (x) {
            ...
            var gap, mod, orient;
            orient =
                this.orient == 'past' || this.operator == 'subtract' ? -1 : 1;
