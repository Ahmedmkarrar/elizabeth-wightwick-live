...
(function ($) {
    ...
    $.jcarousel = function (e, o) {
        ...
        if (
            ...
            this.buttonPrev = $(this.options.buttonPrevHTML).appendTo(
                this.container
            );
        }
        ...
        if (
            ...
            this.buttonNext = $(this.options.buttonNextHTML).appendTo(
                this.container
            );
        }
        ...
        if (!this.options.vertical && this.options.rtl) {
            this.container
                .addClass('jcarousel-direction-rtl')
                .attr('dir', 'rtl');
        }
    ...
    $jc.fn.extend({
        ...
        add: function (i, s) {
            ...
            if (i > 0 && i < this.first) {
                this.list.css(
                    this.lt,
                    $jc.intval(this.list.css(this.lt)) - wh + 'px'
                );
            }

            this.list.css(
                this.wh,
                $jc.intval(this.list.css(this.wh)) + wh + 'px'
            );
        ...
        remove: function (i) {
            ...
            this.list.css(
                this.wh,
                $jc.intval(this.list.css(this.wh)) - d + 'px'
            );
        },
        ...
        pos: function (i, fv) {
            ...
            if (l > 0) {
                ...
                if (back) {
                    ...
                    this.list.css(
                        this.lt,
                        $jc.intval(this.list.css(this.lt)) - l + 'px'
                    );
                }
            }
