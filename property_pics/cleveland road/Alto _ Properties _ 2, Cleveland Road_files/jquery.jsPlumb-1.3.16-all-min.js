jsPlumbUtil = {
    ...
    pointOnLine: function (a, e, b) {
        var d = jsPlumbUtil.gradient(a, e),
            ...
            h =
                b > 0
                    ? jsPlumbUtil.segmentMultipliers[i]
                    : jsPlumbUtil.inverseSegmentMultipliers[i],
            c = Math.atan(d),
        ...
        this.fire = function (g, h, d) {
            if (c[g]) {
                for (var f = 0; f < c[g].length; f++) {
                    if (
                        jsPlumbUtil.findWithFunction(a, function (i) {
                            return i === g;
                        }) != -1
                    ) {
                        c[g][f](h, d);
        ...
        this.updateOffsets = function (o) {
            ...
            if (n) {
                for (var q in n) {
                    ...
                    f[l][q] = {
                        id: q,
                        offset: { left: p.left - k.left, top: p.top - k.top }
                    };
                }
            }
        };
...
(function () {
    ...
    var v = null,
        ...
        B = function (aa) {
            ...
            U.hoverClass =
                aa.hoverClass ||
                U._jsPlumb.Defaults.HoverClass ||
            ...
            this.setHover = function (ad, af, ae) {
                if (
                    !U._jsPlumb.currentlyDragging &&
                    !U._jsPlumb.isHoverSuspended()
                ) {
                    S = ad;
                ...
                Q = function (ae) {
                    if (U.getDefaultType) {
                        ...
                        for (var ad = 0; ad < H.length; ad++) {
                            af = jsPlumbUtil.merge(
                                af,
                                U._jsPlumb.getType(H[ad], ag)
                            );
                        }
                        U.applyType(af);
                        if (!ae) {
        ...
        x = function (M) {
            ...
            var K = function (X) {
                    ...
                    if (l(X)) {
                        var U = X[0],
                            W = n.extend(
                                { component: S, _jsPlumb: S._jsPlumb },
                                X[1]
                            );
                        if (X.length == 3) {
                            n.extend(W, X[2]);
                ...
                L = function (X) {
                    var T = S.defaultOverlayKeys || [],
                        ...
                        U = function (Y) {
                            return (
                                S._jsPlumb.Defaults[Y] || n.Defaults[Y] || []
                            );
                        };
                    if (!W) {
                        W = [];
            ...
            if (M.label) {
                var P = M.labelLocation || S.defaultLabelLocation || 0.5,
                    Q =
                        M.labelStyle ||
                        S._jsPlumb.Defaults.LabelStyle ||
                        n.Defaults.LabelStyle;
                this.overlays.push(
                    R({ label: M.label, location: P, labelStyle: Q })
                );
            }
    ...
    var w = function (I) {
        ...
        var O = null,
            ...
            bg = function (bD, bz, bG) {
                if (!jsPlumbAdapter.headless) {
                    ...
                    if (bI) {
                        if (
                            bE.isDragSupported(bD) &&
                            !bE.isAlreadyDraggable(bD)
                        ) {
                            var bH =
                                bG ||
                                br.Defaults.DragOptions ||
            ...
            aC = function (bF, bA) {
                ...
                if (bz.sourceEndpoint && bz.sourceEndpoint.connectorOverlays) {
                    ...
                    for (
                        var bD = 0;
                        bD < bz.sourceEndpoint.connectorOverlays.length;
                        bD++
                    ) {
                        bz.overlays.push(
                            bz.sourceEndpoint.connectorOverlays[bD]
                        );
                    }
                }
                ...
                if (
                    ...
                    if (bG) {
                        ...
                        var bC =
                            bB != null ? bB : br.addEndpoint(bz.target, bG);
                        if (bl[bE]) {
                            aK[bE] = bC;
                        }
                ...
                if (
                    ...
                    if (bG) {
                        ...
                        var bC =
                            bB != null ? bB : br.addEndpoint(bz.source, bG);
                        if (bc[bE]) {
                            a6[bE] = bC;
                        }
            ...
            af = function (bD) {
                var bC =
                        br.Defaults.ConnectionType ||
                        br.getDefaultConnectionType(),
        ...
        this.addEndpoint = function (bC, bD, bM) {
            ...
            n.extend(bB, bD);
            bB.endpoint =
                bB.endpoint || br.Defaults.Endpoint || n.Defaults.Endpoint;
            bB.paintStyle =
                bB.paintStyle ||
        ...
        this.checkASyncCondition = function (bB, bD, bC, bA) {
            ...
            if (bz && bz.length > 0) {
                try {
                    ...
                    o(
                        br,
                        'cannot asynchronously check condition [' +
                            bB +
                            ']' +
                            bE
                    );
        ...
        this.detach = function () {
            ...
            var bD =
                    br.Defaults.ConnectionType || br.getDefaultConnectionType(),
            ...
            if (bA) {
                if (
                    ...
                    (bA.isDetachAllowed(bA) &&
                        bA.endpoints[0].isDetachAllowed(bA) &&
                        bA.endpoints[1].isDetachAllowed(bA))
                ) {
                    ...
                    if (l(bE)) {
                        if (l(bE[0]) || z(bE[0])) {
                            if (bE.length == 2 && z(bE[0]) && u(bE[1])) {
                                var bz = n.extend(
                                    { elementId: bB, jsPlumbInstance: br },
                                    bE[1]
                                );
                            ...
                            var bD = {
                                ...
                                y: bE[1],
                                orientation:
                                    bE.length >= 4 ? [bE[2], bE[3]] : [0, 0],
                                offsets:
                                    bE.length == 6 ? [bE[4], bE[5]] : [0, 0],
                                elementId: bB
                            };
                            bC = new ab(bD);
                            bC.clone = function () {
        ...
        var a1 = {},
            ...
            ac = function (bz, bA) {
                ...
                bz.anchor =
                    bz.anchor ||
                    br.Defaults.Anchors[bA] ||
                    br.Defaults.Anchor ||
                    n.Defaults.Anchors[bA] ||
                    n.Defaults.Anchor;
                bz.endpoint =
                    bz.endpoint ||
                    br.Defaults.Endpoints[bA] ||
                    br.Defaults.Endpoint ||
                    n.Defaults.Endpoints[bA] ||
                    n.Defaults.Endpoint;
            };
            ...
            _doOne = function (bO) {
                ...
                var bL = n.extend({}, bA.dropOptions || {}),
                    bK = function () {
                        ...
                        var bW = proxyComponent.isDropAllowed(
                            bY.sourceId,
                            H(bO),
                            bY.scope,
                            bY,
                        ...
                        if (bY.suspendedEndpoint) {
                            ...
                            bY.target = bH.getElementObject(
                                bY.suspendedEndpoint.elementId
                            );
                        ...
                        if (bW) {
                            ...
                            if (b2.anchor.positionFinder != null) {
                                var bZ = bH.getUIPosition(
                                        arguments,
                                        br.getZoom()
                                    ),
                                    bV = s(bO, br),
                                    b0 = a(bO),
                                    bU = b2.anchor.positionFinder(
                                        bZ,
                                        bV,
                                        b0,
                            ...
                            var bX = br.connect({
                                ...
                                doNotFireConnectionEvent:
                                    bQ.endpointWillMoveAfterConnection
                            });
                            if (
                                bY.endpoints[1]._makeTargetCreator &&
            ...
            var bH = n.CurrentLibrary,
                ...
                bz = function (bQ) {
                    var bK = H(bQ),
                        bR = bB.parent,
                        bJ =
                            bR != null ? br.getId(bH.getElementObject(bR)) : bK;
                    aB[bJ] = bB;
                    ...
                    var bM = function (bZ) {
                        ...
                        if (bB.parent) {
                            ...
                            b3 = X({ elId: bY });
                            (b7 =
                                ((bZ.pageX || bZ.page.x) - b3.left) / b3.width),
                                (b6 =
                                    ((bZ.pageY || bZ.page.y) - b3.top) /
                                    b3.height);
                        }
                        var b5 = {};
                        n.extend(b5, bB);
                        ...
                        if (bB.parent) {
                            ...
                            if (bW) {
                                ...
                                b5.container = n.CurrentLibrary.getParent(
                                    bB.parent
                                );
                            }
                        }
                        ...
                        bU.endpointWillMoveTo = bB.parent
                            ? bH.getElementObject(bB.parent)
                            : null;
                        var b4 = function () {
                            if (bO) {
                                br.deleteEndpoint(bU);
        ...
        var aP = function (bD, bC, bE, bz) {
            ...
            if (z(bC)) {
                ...
                if (bC.length) {
                    bC = aL(bC);
                    for (var bB = 0; bB < bC.length; bB++) {
                        var bF = (_el = n.CurrentLibrary.getElementObject(
                                bC[bB]
                            )),
                            bF = H(_el);
                        bA[bF] = bz ? !bA[bF] : bE;
        ...
        var bs = function (bE, bB) {
            ...
            if (bC != null) {
                var bA =
                        bC.tagName.toLowerCase() === 'body'
                            ? { left: 0, top: 0 }
                            : s(bC, br),
                    bD =
                        bC.tagName.toLowerCase() === 'body'
                            ? { left: 0, top: 0 }
                            : { left: bC.scrollLeft, top: bC.scrollTop };
        ...
        var au = function (bB, bA, bG) {
            ...
            var bJ = [],
                bI = this,
                bH = function (bK) {
                    return bK.constructor == ab
                        ? bK
                        : br.makeAnchor(bK, bG, br);
                };
            ...
            var bC = bJ.length > 0 ? bJ[0] : null,
                ...
                bD = function (bQ, bN, bM, bR, bL) {
                    var bK = bR[0] + bQ.x * bL[0],
                        ...
                        bO = bR[1] + bL[1] / 2;
                    return (
                        Math.sqrt(Math.pow(bN - bK, 2) + Math.pow(bM - bS, 2)) +
                        Math.sqrt(Math.pow(bP - bK, 2) + Math.pow(bO - bS, 2))
                    );
                },
                bz =
                    bA ||
        ...
        var bn = {},
            ...
            bp = function (bI, bJ, bF, bC) {
                ...
                var bA = Math.atan2(
                        bC.centery - bF.centery,
                        bC.centerx - bF.centerx
                    ),
                    bD = Math.atan2(
                        bF.centery - bC.centery,
                        bF.centerx - bC.centerx
                    ),
                    bE =
                        (bF.left <= bC.left && bF.right >= bC.left) ||
                        (bF.left <= bC.right && bF.right >= bC.right) ||
                        (bF.left <= bC.left && bF.right >= bC.right) ||
                        (bC.left <= bF.left && bC.right >= bF.right),
                    bK =
                        (bF.top <= bC.top && bF.bottom >= bC.top) ||
                        (bF.top <= bC.bottom && bF.bottom >= bC.bottom) ||
                        (bF.top <= bC.top && bF.bottom >= bC.bottom) ||
                        (bC.top <= bF.top && bC.bottom >= bF.bottom);
                if (!(bE || bK)) {
                    var bH = null,
                        bB = false,
                        bz = false,
            ...
            M = function (bA, bz) {
                var bC =
                        bA[0][0] < 0 ? -Math.PI - bA[0][0] : Math.PI - bA[0][0],
                    bB =
                        bz[0][0] < 0 ? -Math.PI - bz[0][0] : Math.PI - bz[0][0];
                if (bC > bB) {
                    return 1;
                } else {
            ...
            a2 = { top: bb, right: aa(true), bottom: aa(true), left: M },
            ar = function (bz, bA) {
                return bz.sort(bA);
            },
            ao = function (bA, bz) {
        ...
        var az = function (bU) {
            ...
            this.getDefaultType = function () {
                return {
                    ...
                    paintStyle:
                        bK._jsPlumb.Defaults.PaintStyle ||
                        n.Defaults.PaintStyle,
                    connector:
                        bK._jsPlumb.Defaults.Connector || n.Defaults.Connector,
                    hoverPaintStyle:
                        bK._jsPlumb.Defaults.HoverPaintStyle ||
                        n.Defaults.HoverPaintStyle,
                    overlays:
                        bK._jsPlumb.Defaults.ConnectorOverlays ||
                ...
                if (z(bW)) {
                    ...
                    if (l(bW)) {
                        if (bW.length == 1) {
                            ...
                            this.connector = new n.Connectors[Y][bW[0]](
                                n.extend(bW[1], bZ)
                            );
                        }
                    }
            ...
            if (bU.sourceEndpoint) {
                this.source =
                    bU.sourceEndpoint.endpointWillMoveTo ||
                ...
                bO = function (bW, b2, bX, bZ, b0, bY, b1) {
                    ...
                    if (bW) {
                        ...
                        var b4 = bX.anchors
                                ...
                                : bX.anchor
                                ? bX.anchor
                                : bT(br.Defaults.Anchors[b2], b0) ||
                                  bT(n.Defaults.Anchors[b2], b0) ||
                                  bT(br.Defaults.Anchor, b0) ||
                                  bT(n.Defaults.Anchor, b0),
                        ...
                        b3 = aH({
                            ...
                            reattach:
                                bX.reattach || br.Defaults.ReattachConnections,
                            detachable:
                                bX.detachable ||
            ...
            var bG =
                bU.reattach ||
                bK.endpoints[0].reattachConnections ||
        ...
        var bh = function (bA) {
            ...
            return {
                drag: function () {
                    ...
                    var bB = n.CurrentLibrary.getUIPosition(
                            arguments,
                            br.getZoom()
                        ),
                        bC = bA.element;
        ...
        var ah = function (b5) {
            ...
            this.getDefaultType = function () {
                return {
                    ...
                    paintStyle:
                        bS._jsPlumb.Defaults.EndpointStyle ||
                        n.Defaults.EndpointStyle,
                    endpoint:
                        bS._jsPlumb.Defaults.Endpoint || n.Defaults.Endpoint,
                    hoverPaintStyle:
                        bS._jsPlumb.Defaults.EndpointHoverStyle ||
                        n.Defaults.EndpointHoverStyle,
                    overlays:
                        bS._jsPlumb.Defaults.EndpointOverlays ||
            ...
            this.setVisible = function (b8, cb, b7) {
                ...
                if (!cb) {
                    for (var ca = 0; ca < bS.connections.length; ca++) {
                        ...
                        if (!b7) {
                            var b9 =
                                bS === bS.connections[ca].endpoints[0] ? 1 : 0;
                            if (
                                bS.connections[ca].endpoints[b9].connections
                                    .length == 1
                            ) {
                                bS.connections[ca].endpoints[b9].setVisible(
                                    b8,
                                    true,
                                    true
                                );
            ...
            bS.anchor = b5.anchor
                ? br.makeAnchor(b5.anchor, bJ, br)
                : b5.anchors
                ? br.makeAnchor(b5.anchors, bJ, br)
                : br.makeAnchor(br.Defaults.Anchor || 'TopCenter', bJ, br);
            if (!b5._transient) {
            ...
            this.timestamp = null;
            bS.reattachConnections =
                b5.reattach || br.Defaults.ReattachConnections;
                            ...
                            if (!cd) {
                                ...
                                if (b8.endpointsToDeleteOnDetach) {
                                    for (
                                        var cc = 0;
                                        cc <
                                        b8.endpointsToDeleteOnDetach.length;
                                        cc++
                                    ) {
                                        var ca =
                                            b8.endpointsToDeleteOnDetach[cc];
            ...
            this.detachFrom = function (ca, b9, b7) {
                ...
                for (var b8 = 0; b8 < bS.connections.length; b8++) {
                    if (
                        bS.connections[b8].endpoints[1] == ca ||
            ...
            this.setElement = function (ca, b7) {
                ...
                bJ = H(bR);
                bS.elementId = bJ;
                var cb = ay({ source: cc, container: b7 }),
            ...
            this.paint = function (ca) {
                ...
                if (!cg || bS.timestamp !== cg) {
                    ...
                    if (cm) {
                        ...
                        var ch = bP.compute(
                            cd,
                            bS.anchor.getOrientation(bS),
                            bS.paintStyleInUse,
                            cb || bS.paintStyleInUse
                        );
                        ...
                        for (var ce = 0; ce < bS.overlays.length; ce++) {
                            ...
                            if (b8.isVisible) {
                                bS.overlayPlacements[ce] = b8.draw(
                                    bS.endpoint,
                                    bS.paintStyleInUse,
                                    ch
                                );
            ...
            var bI = function (b9, ce, cc, cf) {
                if (
                    (b5.isTarget || ce) &&
                    n.CurrentLibrary.isDropSupported(bR)
                ) {
                    var ca =
                        b5.dropOptions ||
                        br.Defaults.DropOptions ||
                    ...
                    var b8 = n.CurrentLibrary.dragEvents.drop,
                        ...
                        cb = function () {
                            var cg = n.CurrentLibrary.getDropEvent(arguments),
                                ct = C(
                                    n.CurrentLibrary.getDragObject(arguments)
                                ),
                                ci = c(ct, 'dragId'),
                                ck = c(ct, 'elId'),
                            ...
                            var cl =
                                ...
                                (cn.suspendedEndpoint.id == bS.id ||
                                    (bS.referenceEndpoint &&
                                        cn.suspendedEndpoint.id ==
                                            bS.referenceEndpoint.id));
                            if (cl) {
                            ...
                            if (cn != null) {
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        if (cp == 0) {
                                            cn.source =
                                                cn.suspendedEndpoint.element;
                                            cn.sourceId =
                                                cn.suspendedEndpoint.elementId;
                                        } else {
                                            cn.target =
                                                cn.suspendedEndpoint.element;
                                            cn.targetId =
                                        ...
                                        if (
                                            !cn.isDetachAllowed(cn) ||
                                            !cn.endpoints[cp].isDetachAllowed(
                                                cn
                                            ) ||
                                            !cn.suspendedEndpoint.isDetachAllowed(
                                                cn
                                            ) ||
                                            !br.checkCondition(
                                                'beforeDetach',
                                    ...
                                    var ch = function () {
                                        cn.endpoints[cp].detachFromConnection(
                                            cn
                                        );
                                        if (cn.suspendedEndpoint) {
                                            cn.suspendedEndpoint.detachFromConnection(
                                                cn
                                            );
                                        }
                                        cn.endpoints[cp] = bS;
                                        ...
                                        if (!cn.suspendedEndpoint) {
                                            ...
                                            var cw =
                                                    cn.suspendedEndpoint.getElement(),
                                                cu =
                                                    cn.suspendedEndpoint
                                                        .elementId;
                                            ba(
                                    ...
                                    var cj = function () {
                                        if (cn.suspendedEndpoint) {
                                            ...
                                            cn.suspendedEndpoint.addConnection(
                                                cn
                                            );
                    ...
                    ca[cd] = ap(ca[cd], function () {
                        ...
                        if (cj != null) {
                            var cg =
                                cj.floatingAnchorIndex == null
                                    ? 1
                                    : cj.floatingAnchorIndex;
                            var ci =
                                (bS.isTarget && cj.floatingAnchorIndex != 0) ||
                                (cj.suspendedEndpoint &&
                                    bS.referenceEndpoint &&
                                    bS.referenceEndpoint.id ==
                                        cj.suspendedEndpoint.id);
                            if (ci) {
            ...
            bI(
                C(bS.canvas),
                true,
                !(b5._transient || bS.anchor.isFloating),
                bS
            );
            if (b5.type) {
                bS.addType(b5.type);
    ...
    var q = function (H, M, J, I, L, K) {
        return function (O) {
            O = O || {};
            var N = O.jsPlumbInstance.makeAnchor(
                [H, M, J, I, 0, 0],
                O.elementId,
                O.jsPlumbInstance
            );
    ...
    n.Defaults.DynamicAnchors = function (H) {
        return H.jsPlumbInstance.makeAnchors(
    ...
    n.Anchors.AutoDefault = function (I) {
        var H = I.jsPlumbInstance.makeDynamicAnchor(
            n.Defaults.DynamicAnchors(I)
        );
        H.type = 'AutoDefault';
        return H;
    };
    n.Anchors.Assign = q(0, 0, 0, 0, 'Assign', function (I, J) {
        ...
        I.positionFinder =
            H.constructor == String
                ? J.jsPlumbInstance.AnchorPositionFinders[H]
                : H;
    ...
    n.Anchors.Perimeter = function (H) {
            ...
            Q = function (X, W) {
                ...
                for (var U = 0; U < X.length; U++) {
                    var T = X[U][0] - 0.5,
                        S = X[U][1] - 0.5;
                    Y.push([
                        0.5 + (T * Math.cos(V) - S * Math.sin(V)),
                        0.5 + (T * Math.sin(V) + S * Math.cos(V)),
                        X[U][2],
                        X[U][3]
                    ]);
                }
        ...
        if (!K[L]) {
            throw new Error(
                'Shape [' + L + '] is unknown by Perimeter Anchor type'
            );
        }
        var R = K[L](H);
        if (H.rotation) {
...
(function () {
    ...
    jsPlumb.Connectors.Straight = function () {
        ...
        this.compute = function (B, K, t, A, G, u, E, z) {
            ...
            k = [H, F, J, D, i, h, e, d];
            (o = e - i), (m = d - h);
            (f = jsPlumbUtil.gradient({ x: i, y: h }, { x: e, y: d })),
                (l = -1 / f);
            q = -1 * (f * i - h);
            g = Math.atan(f);
            r = Math.atan(l);
                ...
                K = {
                    oppositex: function () {
                        if (D.elementId == U.elementId) {
                            var aB =
                                ac + (1 - az.y) * au.height + Math.max(k, p);
                            return [
                                [ad, aB],
                                [P, aB]
                            ];
                    ...
                    oppositey: function () {
                        if (D.elementId == U.elementId) {
                            var aB =
                                ad + (1 - az.x) * au.width + Math.max(k, p);
                            return [
                                [aB, ac],
                                [aB, N]
                            ];
    ...
    var c = function (f) {
        ...
        this.endpointLoc =
            f.endpointLocation == null ? [0.5, 0.5] : f.endpointLocation;
    ...
    jsPlumb.Overlays.Diamond = function (f) {
        f = f || {};
        var d = f.length || 40,
            e = jsPlumb.extend(f, { length: d / 2, foldback: 2 });
    ...
    var a = function (i) {
        ...
        this.getDimensions = function () {
            return jsPlumb.CurrentLibrary.getSize(
                jsPlumb.CurrentLibrary.getElementObject(d.getElement())
            );
        };
        var f = null,
            k = function (m) {
    ...
    jsPlumb.Overlays.Label = function (h) {
        ...
        this.cssClass =
            this.labelStyle != null ? this.labelStyle.cssClass : null;
        h.create = function () {
                ...
                var N = (o + g) / 2,
                    ...
                    P =
                        A == Infinity || A == -Infinity
                            ? 0
                            : Math.abs((d / 2) * Math.sin(V)),
                    R =
                        A == Infinity || A == -Infinity
                            ? 0
                            : Math.abs((d / 2) * Math.cos(V)),
                    B = a(o, m, g, e),
...
(function () {
    ...
    var t = 1000,
                ...
                if (x != null) {
                    ...
                    if (x.outlineColor) {
                        var C = x.outlineWidth || 1,
                            D = x.lineWidth + 2 * C,
                            B = {
                                strokeStyle: jsPlumbUtil.convertStyle(
                                    x.outlineColor
                                ),
                                lineWidth: D
                            };
        ...
        l = (window.VmlEndpoint = function (y) {
            ...
            var w =
                v._jsPlumb.endpointClass + (y.cssClass ? ' ' + y.cssClass : '');
    ...
    var l = {
        ...
        i = function (E) {
            for (var D = 0; D < E.childNodes.length; D++) {
                if (
                    E.childNodes[D].tagName == e ||
                    E.childNodes[D].tagName == b
                ) {
        ...
        x = function (K, G, E, D, H) {
            ...
            G.setAttribute(
                c,
                E.fillStyle ? jsPlumbUtil.convertStyle(E.fillStyle, true) : m
            );
            G.setAttribute(
                z,
                E.strokeStyle
                    ? jsPlumbUtil.convertStyle(E.strokeStyle, true)
                    : m
            );
            if (E.lineWidth) {
    ...
    var k = function () {
        ...
        this._over = function (z) {
            ...
            if (u > 0 && C > 0 && u < q.canvas.width && C < q.canvas.height) {
                ...
                var A = q.canvas
                    .getContext('2d')
                    .getImageData(parseInt(u), parseInt(C), 1, 1);
                return (
                    A.data[0] != 0 ||
                    A.data[1] != 0 ||
                    A.data[2] != 0 ||
        ...
        this._paint = function (r, t) {
            ...
            if (t.dashstyle && t.dashstyle.split(' ').length == 2) {
                ...
                var C = [v[0] * t.lineWidth, v[1] * t.lineWidth],
                    ...
                    u = Math.atan(y),
                    z = Math.sqrt(
                        Math.pow(r[6] - r[4], 2) + Math.pow(r[7] - r[5], 2)
                    ),
...
(function (a) {
    jsPlumb.CurrentLibrary = {
        ...
        trigger: function (d, e, b) {
            var c = jQuery._data(
                jsPlumb.CurrentLibrary.getElementObject(d)[0],
                'handle'
            );
            c(b);
        },
...
(function () {
    ...
    var d = {
        ...
        c = function (m, l) {
            for (
                var p = e(m.length - 1), q = 0, n = 0, o = 0;
                o < m.length;
                o++
            ) {
                q = q + m[o].x * p[o](l);
        ...
        b = function (m, l, p) {
            for (
                var q = c(m, l), n = 0, o = p > 0 ? 1 : -1, r = null;
                n < Math.abs(p);
                ...
                n =
                    n +
                    Math.sqrt(Math.pow(r.x - q.x, 2) + Math.pow(r.y - q.y, 2));
                q = r;
            }
