    ...
    d.widget('ech.multiselect', {
        ...
        _create: function () {
            ...
            a = (this.button = d(
                ...
                .insertAfter(a);
            (this.buttonlabel = d('<span />'))
                .html(b.noneSelectedText)
                .appendTo(a);
            var a = (this.menu = d('<div />'))
                    .addClass(
        ...
        refresh: function (a) {
            ...
            this.element.find('option').each(function (a) {
                ...
                var e = this.parentNode,
                    c = this.innerHTML,
                    i = this.value,
                    a = this.id || 'ui-multiselect-' + g + '-option-' + a,
                    j = this.disabled,
                    l = this.selected,
                    k = ['ui-corner-all'];
                e.tagName.toLowerCase() === 'optgroup' &&
                    ((e = e.getAttribute('label')),
                    d.inArray(e, h) === -1 &&
                        (f.push(
                            '<li class="ui-multiselect-optgroup-label"><a href="#">' +
                                e +
                                '</a></li>'
                        ),
                        h.push(e)));
                ...
                f.push(
                    '<li class="' + (j ? 'ui-multiselect-disabled' : '') + '">'
                );
        ...
        update: function () {
            var a = this.options,
                ...
                a =
                    e === 0
                        ? a.noneSelectedText
                        : d.isFunction(a.selectedText)
                        ? a.selectedText.call(this, e, b.length, c.get())
                        : /\d/.test(a.selectedList) &&
                          a.selectedList > 0 &&
                          e <= a.selectedList
                        ? c
                              .map(function () {
                              ...
                              .get()
                              .join(', ')
                        : a.selectedText.replace('#', e).replace('#', b.length);
        ...
        _bindEvents: function () {
            ...
            this.header.delegate('a', 'click.multiselect', function (a) {
                if (d(this).hasClass('ui-multiselect-close')) b.close();
                    ...
                    b[
                        d(this).hasClass('ui-multiselect-all')
                            ? 'checkAll'
                            : 'uncheckAll'
                    ]();
                a.preventDefault();
                ...
                .delegate(
                    ...
                    function (a) {
                        ...
                        b._trigger('click', a, {
                            ...
                            ? a.preventDefault()
                            : (c.attr('aria-selected', g),
                              i.each(function () {
                                  if (this.value === f) this.selected = g;
                                  else if (!b.options.multiple)
                                      this.selected = !1;
                              }),
                              b.options.multiple ||
            ...
            d(document).bind('mousedown.multiselect', function (a) {
                b._isOpen &&
                    !d.contains(b.menu[0], a.target) &&
                    !d.contains(b.button[0], a.target) &&
                    a.target !== b.button[0] &&
                    b.close();
            });
        ...
        _traverse: function (a, b) {
            var c = d(b),
                ...
                c = c
                    ...
                    [e ? 'last' : 'first']();
            c.length
                ? c.find('label').trigger('mouseover')
                : ((c = this.menu.find('ul:last')),
                  this.menu
                      .find('label')
                      [e ? 'last' : 'first']()
                      .trigger('mouseover'),
                  c.scrollTop(e ? c.height() : 0));
        },
        ...
        _toggleChecked: function (a, b) {
            ...
            this.element.find('option').each(function () {
                !this.disabled &&
                    d.inArray(this.value, h) > -1 &&
                    e._toggleCheckbox('selected', a).call(this);
            });
        },
        _toggleDisabled: function (a) {
            this.button
                .attr({ disabled: a, 'aria-disabled': a })
        ...
        open: function () {
            ...
            if (
                ...
                var h = b.find('ul:last'),
                    ...
                    g = a.position();
                d.isArray(e.show) &&
                    ((f = e.show[0]), (c = e.show[1] || this.speed));
                h.scrollTop(0).height(e.height);
                d.ui.position && !d.isEmptyObject(e.position)
                    ? ((e.position.of = e.position.of || a),
                      b.show().position(e.position).hide().show(f, c))
                    : b
                          .css({ top: g.top + a.outerHeight(), left: g.left })
                          .show(f, c);
                this.labels
                    .eq(0)
                    .trigger('mouseover')
        ...
        close: function () {
            if (this._trigger('beforeclose') !== !1) {
                var a = this.options,
                    ...
                    c = this.speed;
                d.isArray(a.hide) &&
                    ((b = a.hide[0]), (c = a.hide[1] || this.speed));
                this.menu.hide(b, c);
                this.button
