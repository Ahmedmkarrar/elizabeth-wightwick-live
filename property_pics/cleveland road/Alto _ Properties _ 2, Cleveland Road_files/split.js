// Author: https://nathancahill.github.io/Split.js/
/*! Split.js - v1.3.5 */
...
(function (global, factory) {
    ...
    var Split = function (ids, options) {
        ...
        function drag(e) {
            ...
            if (
                offset <=
                elements[this.a].minSize + snapOffset + this.aGutterSize
            ) {
                offset = elements[this.a].minSize + this.aGutterSize;
            } else if (
                offset >=
                this.size -
                    (elements[this.b].minSize + snapOffset + this.bGutterSize)
            ) {
                offset =
                    this.size - (elements[this.b].minSize + this.bGutterSize);
            }
