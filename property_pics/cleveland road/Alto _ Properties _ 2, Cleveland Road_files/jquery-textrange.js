        ...
        _textrange = {
            ...
            msie: {
                ...
                set: function (start, end) {
                    ...
                    var ieStart =
                        start -
                        (this[0].value.slice(0, start).split('\r\n').length -
                            1);
                    var ieEnd =
                        end -
                        (this[0].value.slice(0, end).split('\r\n').length - 1);
    ...
    $.fn.extend({
        textrange: function (arg) {
            ...
            if (typeof textrange[method] === 'function') {
                return textrange[method].apply(
                    this,
                    Array.prototype.slice.call(arguments, 1)
                );
            } else {
                $.error(
                    'Method ' + method + ' does not exist in jQuery.textrange'
                );
            }
        }
    });
