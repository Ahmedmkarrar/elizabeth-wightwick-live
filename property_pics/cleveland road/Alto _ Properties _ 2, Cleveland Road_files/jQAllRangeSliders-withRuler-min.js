/*! jQRangeSlider 5.7.2 - 2016-01-18 - Copyright (C) Guillaume Gautreau 2012 - MIT and GPLv3 licenses.*/ !(function (
    a,
    b
) {
    'use strict';
    a.widget('ui.rangeSliderMouseTouch', a.ui.mouse, {
        ...
        _touchMove: function (a) {
            return (
                a.preventDefault(), this._fillTouchEvent(a), this._mouseMove(a)
            );
        },
    ...
    (function (a, b) {
        ...
        a.widget('ui.rangeSliderDraggable', a.ui.rangeSliderMouseTouch, {
            ...
            _mouseDrag: function (a) {
                ...
                return (
                    (b = this._constraintPosition(
                        b + this.cache.initialOffset.left
                    )),
        ...
        a.widget('ui.rangeSlider', {
            ...
            _setLabelsDurations: function (a, b) {
                if (
                    ...
                    null !== this.labels.left &&
                        this._leftLabel('option', a, b),
                        null !== this.labels.right &&
            ...
            _createElements: function () {
                'absolute' !== this.element.css('position') &&
                    ...
                    (this.container = a(
                        "<div class='ui-rangeSlider-container' />"
                    )
            ...
            _createBar: function () {
                (this.bar = a('<div />')
                    ...
                    (this.options.wheelSpeed = this._bar(
                        'option',
                        'wheelSpeed'
                    ));
            },
            ...
            _getFormatter: function () {
                return this.options.formatter === !1 ||
                    null === this.options.formatter
        ...
        a.widget('ui.rangeSliderHandle', a.ui.rangeSliderDraggable, {
            ...
            _create: function () {
                a.ui.rangeSliderDraggable.prototype._create.apply(this),
                    ...
                    this.element.append(
                        "<div class='ui-rangeSlider-handle-inner' />"
                    ),
            ...
            _setOption: function (b, c) {
                ...
                c === this.options.isLeft
                    ...
                    a.ui.rangeSliderDraggable.prototype._setOption.apply(this, [
                        b,
                        c
                    ]);
            },
            _checkRange: function (a) {
                return (
                    a === !1 ||
                    (!this._isValidValue(a.min) && !this._isValidValue(a.max))
                );
            },
            _isValidValue: function (a) {
                return (
                    'undefined' != typeof a && a !== !1 && parseFloat(a) !== a
                );
            },
            ...
            _initElement: function () {
                a.ui.rangeSliderDraggable.prototype._initElement.apply(this),
                    0 === this.cache.parent.width ||
                    null === this.cache.parent.width
                        ? setTimeout(
                              a.proxy(this._initElementIfNotDestroyed, this),
                              500
                          )
            ...
            _prepareEventData: function () {
                var b =
                    a.ui.rangeSliderDraggable.prototype._prepareEventData.apply(
                        this
                    );
            ...
            moveRight: function (a) {
                ...
                return this.options.step === !1
                    ...
                    : ((b = this._value),
                      this.value(
                          this.add(b, this.multiplyStep(this.options.step, a))
                      ),
        ...
        a.widget('ui.rangeSliderBar', a.ui.rangeSliderDraggable, {
            ...
            _bindMouseWheel: function (b) {
                'zoom' === b
                    ? this.element
                          ...
                          .bind(
                              'mousewheel.bar',
                              a.proxy(this._mouseWheelZoom, this)
                          )
                    : 'scroll' === b &&
                      this.element
                          .parent()
                          .bind(
                              'mousewheel.bar',
                              a.proxy(this._mouseWheelScroll, this)
                          );
            },
            ...
            _initMe: function () {
                ...
                var a = this._leftHandle('position'),
                    b =
                        this._rightHandle('position') +
                        this.options.rightHandle.width();
            ...
            _cacheHandles: function () {
                (this.cache.rightHandle = {}),
                    (this.cache.rightHandle.width =
                        this.options.rightHandle.width()),
                    (this.cache.rightHandle.offset =
                        this.options.rightHandle.offset()),
                    (this.cache.leftHandle = {}),
                    (this.cache.leftHandle.offset =
                        this.options.leftHandle.offset());
            },
            _mouseStart: function (b) {
                a.ui.rangeSliderDraggable.prototype._mouseStart.apply(this, [
                    b
                ]),
            ...
            _mouseWheelZoom: function (b, c, d, e) {
                ...
                var f =
                        this._values.min +
                        (this._values.max - this._values.min) / 2,
                    g = {},
                    h = {};
                return (
        ...
        function c(b, c, d, e) {
            (this.label1 = b),
                ...
                (this.Init = function () {
                    this.BindHandle(this.handle1),
                        ...
                        'show' === this.options.show
                            ? (setTimeout(
                                  a.proxy(this.PositionLabels, this),
                                  1
                              ),
                              (this.initialized = !0))
                            : setTimeout(a.proxy(this.AfterInit, this), 1e3),
                        (this._resizeProxy = a.proxy(
                            this.onWindowResize,
                            this
                        )),
                        a(window).resize(this._resizeProxy);
                ...
                (this.BindHandle = function (b) {
                    b.bind(
                        'updating.positionner',
                        a.proxy(this.onHandleUpdating, this)
                    ),
                        b.bind(
                            'update.positionner',
                            a.proxy(this.onHandleUpdated, this)
                        ),
                        b.bind(
                            'moving.positionner',
                        ...
                        b.bind(
                            'stop.positionner',
                            a.proxy(this.onHandleStop, this)
                        );
                }),
                (this.PositionLabels = function () {
                    if ((this.CacheIfNecessary(), null !== this.cache)) {
                        var a = this.GetRawPosition(
                                this.cache.label1,
                                this.cache.handle1
                            ),
                            b = this.GetRawPosition(
                                this.cache.label2,
                                this.cache.handle2
                            );
                ...
                (this.getRightPosition = function (a, b) {
                    ...
                    return (
                        (b.left =
                            c + b.cache.margin.left + b.cache.border.left),
                        b
                    );
                }),
                (this.ShowIfNecessary = function () {
                    'show' === this.options.show ||
                        ...
                        (this.label1
                            .stop(!0, !0)
                            .fadeIn(this.options.durationIn || 0),
                        this.label2
                            .stop(!0, !0)
                            .fadeIn(this.options.durationIn || 0),
                        (this.moving = !0));
                ...
                (this.GetRawPosition = function (a, b) {
                    ...
                    return {
                        ...
                        right: e,
                        outerRight:
                            f + a.outerWidth + a.margin.left + a.margin.right,
                        cache: a,
                        center: c
                    };
                }),
            ...
            _updateShowOption: function (a) {
                (this.options.show = a),
                    'show' !== this.options.show
                        ...
                        : (this.element.show(),
                          this._display(
                              this.options.handle[this.options.handleType](
                                  'value'
                              )
                          ),
        ...
        a.widget('ui.dateRangeSlider', a.ui.rangeSlider, {
            ...
            _setOption: function (b, c) {
                ...
                this._isValidDate(c.max)
                    ? a.ui.rangeSlider.prototype._setOption.apply(this, [
                          b,
                          { min: c.min.valueOf(), max: c.max.valueOf() }
                      ])
                    : a.ui.rangeSlider.prototype._setOption.apply(
                          this,
            ...
            option: function (b) {
                if ('bounds' === b || 'defaultValues' === b) {
                    var c = a.ui.rangeSlider.prototype.option.apply(
                        this,
                        arguments
                    );
                    return { min: new Date(c.min), max: new Date(c.max) };
                }
                return a.ui.rangeSlider.prototype.option.apply(
                    this,
                    this._toArray(arguments)
                );
            },
            ...
            values: function (b, c) {
                ...
                return (
                    (d =
                        this._isValidDate(b) && this._isValidDate(c)
                            ? a.ui.rangeSlider.prototype.values.apply(this, [
                                  b.valueOf(),
                                  c.valueOf()
                              ])
                            : a.ui.rangeSlider.prototype.values.apply(
                                  this,
                                  this._toArray(arguments)
                              )),
                    { min: new Date(d.min), max: new Date(d.max) }
                );
            },
            min: function (b) {
                return this._isValidDate(b)
                    ? new Date(
                          a.ui.rangeSlider.prototype.min.apply(this, [
                              b.valueOf()
                          ])
                      )
            ...
            max: function (b) {
                return this._isValidDate(b)
                    ? new Date(
                          a.ui.rangeSlider.prototype.max.apply(this, [
                              b.valueOf()
                          ])
                      )
            ...
            bounds: function (b, c) {
                ...
                return (
                    (d =
                        this._isValidDate(b) && this._isValidDate(c)
                            ? a.ui.rangeSlider.prototype.bounds.apply(this, [
                                  b.valueOf(),
                                  c.valueOf()
                              ])
                            : a.ui.rangeSlider.prototype.bounds.apply(
                                  this,
                                  this._toArray(arguments)
                              )),
                    { min: new Date(d.min), max: new Date(d.max) }
        ...
        a.widget('ui.dateRangeSliderHandle', a.ui.rangeSliderHandle, {
            ...
            _setOption: function (b, c) {
                return 'step' === b
                    ? ((this.options.step = c),
                      this._createSteps(),
                      void this.update())
                    : (a.ui.rangeSliderHandle.prototype._setOption.apply(this, [
                          b,
                          c
                      ]),
            ...
            stepsBetween: function (a, b) {
                ...
                var c = Math.min(a, b),
                    ...
                    g = a > b;
                for (
                    this.add(c, this.options.step) - c < 0 && (f = !0);
                    d > c;

                )
                    f
                        ? (d = this.add(d, this.options.step))
                        : (c = this.add(c, this.options.step)),
                        e++;
                return g ? -e : e;
            },
            multiplyStep: function (a, b) {
    ...
    (function (a, b) {
        ...
        a.widget('ui.editRangeSlider', a.ui.rangeSlider, {
            ...
            _createLabel: function (b, c) {
                var d = a.ui.rangeSlider.prototype._createLabel.apply(this, [
                    b,
                    c
                ]);
                return (
                    null === b &&
                        d.bind(
                            'valueChange',
                            a.proxy(this._onValueChange, this)
                        ),
                    d
                );
            },
            ...
            _getLabelConstructorParameters: function (b, c) {
                var d =
                    a.ui.rangeSlider.prototype._getLabelConstructorParameters.apply(
                        this,
                        [b, c]
                    );
            ...
            _getLabelRefreshParameters: function (b, c) {
                var d =
                    a.ui.rangeSlider.prototype._getLabelRefreshParameters.apply(
                        this,
                        [b, c]
                    );
                return this._addPropertiesToParameter(d);
            ...
            _onValueChange: function (a, b) {
                var c = !1;
                (c = b.isLeft
                    ? this._values.min !== this.min(b.value)
                    : this._values.max !== this.max(b.value)),
    ...
    (function (a) {
        ...
        a.widget('ui.editRangeSliderLabel', a.ui.rangeSliderLabel, {
            ...
            _setOption: function (b, c) {
                'type' === b
                    ? this._setTypeOption(c)
                    : 'step' === b && this._setStepOption(c),
                    a.ui.rangeSliderLabel.prototype._setOption.apply(this, [
                        b,
                        c
                    ]);
            },
            _createInput: function () {
                (this._input = a("<input type='" + this.options.type + "' />")
            ...
            _triggerValue: function (a) {
                var b = this.options.handle[this.options.handleType](
                    'option',
                    'isLeft'
                );
            ...
            _setStepOption: function (a) {
                (this.options.step = a),
                    'number' === this.options.type &&
                        this._input.attr('step', a !== !1 ? a : 'any');
            },
            _displayText: function (a) {
        ...
        a.widget('ui.ruler', {
            ...
            _setOption: function (a, b) {
                return 'min' === a || ('max' === a && b !== this.options[a])
                    ? ((this.options[a] = b), void this._regenerate())
                    : 'scales' === a && b instanceof Array
                    ? ((this.options.scales = b), void this._regenerate())
                    : void 0;
            },
            ...
            _createScale: function (c, d) {
                var e = a.extend({}, b, c),
                    f = a("<div class='ui-ruler-scale' />").appendTo(
                        this.element
                    );
            ...
            _createTicks: function (a, b) {
                ...
                do
                    (c = f),
                        (f = b.next(c)),
                        (d =
                            (Math.min(f, this.options.max) -
                                Math.max(c, this.options.min)) /
                            g),
                        (e = this._createTick(c, f, b)),
                        a.append(e),
                        e.css('width', 100 * d + '%'),
                        h &&
                            c > this.options.min &&
            ...
            _createTick: function (b, c, d) {
                var e = a(
                        "<div class='ui-ruler-tick' style='display:inline-block' />"
                    ),
