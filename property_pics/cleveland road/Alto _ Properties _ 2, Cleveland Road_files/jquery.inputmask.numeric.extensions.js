        ...
        $.extend($.inputmask.defaults.aliases, {
            numeric: {
                mask: function (opts) {
                    function autoEscape(txt) {
                        for (var escapedTxt = '', i = 0; i < txt.length; i++)
                            escapedTxt += opts.definitions[txt[i]]
                                ? '\\' + txt[i]
                                : txt[i];
                        return escapedTxt;
                    }
                    ...
                    opts.placeholder.length > 1 &&
                        ...
                        (opts.radixFocus =
                            opts.radixFocus && '0' == opts.placeholder),
                ...
                postFormat: function (buffer, pos, reformatOnly, opts) {
                    ...
                    if (
                        '' == opts.groupSeparator ||
                        (-1 != $.inArray(opts.radixPoint, buffer) &&
                        ...
                        if (suffixStripped)
                            for (var i = 0, l = opts.suffix.length; l > i; i++)
                    ...
                    if (
                        ...
                        (needsRefresh =
                            0 == bufVal.indexOf(opts.groupSeparator)),
                ...
                canClearPosition: function (
                    ...
                    if (canClear && isFinite(positionInput)) {
                        ...
                        if (
                            matchRslt &&
                            (-1 == radixPosition || radixPosition >= position)
                        )
                            if (0 == matchRslt[0].indexOf('0'))
                                canClear =
                                ...
                                -1 != radixPosition &&
                                    10 > intPart &&
                                    '0' == opts.placeholder.charAt(0) &&
                                    ((maskset.validPositions[position].input =
                                        '0'),
