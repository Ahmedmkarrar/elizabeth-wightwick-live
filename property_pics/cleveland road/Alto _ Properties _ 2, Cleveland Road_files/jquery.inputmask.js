...
!(function (factory) {
    ...
    function generateMaskSet(opts, nocache) {
        function analyseMask(mask) {
            ...
            function insertTestDefinition(mtoken, element, position) {
                ...
                if (
                    ((position =
                        void 0 != position ? position : mtoken.matches.length),
                    maskdef && !escaped)
                ) {
                    maskdef.placeholder = $.isFunction(maskdef.placeholder)
                        ? maskdef.placeholder.call(this, opts)
                        : maskdef.placeholder;
                    for (
                    ...
                    default:
                        if (openenings.length > 0) {
                            if (
                                ((currentOpeningToken =
                                    openenings[openenings.length - 1]),
                                currentOpeningToken.matches.length > 0 &&
                                    !currentOpeningToken.isAlternator &&
                                    ((lastMatch =
        ...
        function generateMask(mask, metadata) {
            ...
            return (
                void 0 == $.inputmask.masksCache[mask] || nocache === !0
                    ? ((masksetDefinition = {
                          mask: mask,
        ...
        if (
            ...
            if (opts.mask.length > 1) {
                opts.keepStatic =
                    void 0 == opts.keepStatic ? !0 : opts.keepStatic;
                var altMask = '(';
                return (
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function getLastValidPosition(closestTo, strict) {
            ...
            return (lastValidPosition =
                (-1 != before && closestTo - before > 1) || closestTo > after
                    ? before
                    : after);
        }
                    ...
                    if (void 0 != t)
                        for (
                            ...
                            if (
                                ...
                                (valid =
                                    isValid(posMatch, t.input, !0, !0) !== !1),
                                    (j = posMatch);
                                break;
                            }
                            if (
        ...
        function stripValidPositions(start, end, nocheck, strict) {
            var i,
                startPos = start;
            (getMaskSet().p = start),
                void 0 != getMaskSet().validPositions[start] &&
                    getMaskSet().validPositions[start].input ==
                        opts.radixPoint &&
                    (end++, startPos++);
            for (i = startPos; end > i; i++)
            ...
            if (void 0 == testPos)
                for (
                    var testPositions = getTests(pos, ndxIntlzr, tstPs),
                        lvp = getLastValidPosition(),
                        lvTest =
                            getMaskSet().validPositions[lvp] || getTests(0)[0],
                        lvTestAltArr =
                            ...
                            if (-1 == altIndex || 'string' == typeof altIndex) {
                                ...
                                for (
                                    ...
                                    if (
                                        ...
                                        var ntndx =
                                            maskToken.matches.indexOf(match) +
                                            1;
                                ...
                                match = alternateToken.matches[altIndex]
                                    ? handleMatch(
            ...
            if (void 0 == ndxIntlzr) {
                for (
                    ...
                    (!getMaskSet().tests[previousPos] ||
                        void 0 == (test = getMaskSet().tests[previousPos][0]));
                ...
                if (void 0 != alternation)
                    for (var decisionPos in getMaskSet().validPositions)
                        if (
                            ...
                            parseInt(decisionPos) > parseInt(lastAlt) &&
                                void 0 != altPos.alternation)
                        ) {
                            var altNdxs = getMaskSet()
                                    .validPositions[lastAlt].locator[
                                        alternation
                                    ].toString()
                                    .split(','),
                                decisionTaker =
                                    altPos.locator[alternation] || altNdxs[0];
        ...
        function isMask(pos) {
            ...
            if (
                ...
                for (
                    var tests = getTests(pos), staticAlternations = !0, i = 0;
                    i < tests.length;
                    i++
                )
                    if (
                        '' != tests[i].match.def &&
                        (void 0 == tests[i].alternation ||
                            tests[i].locator[tests[i].alternation].length > 1)
                    ) {
        ...
        function getMaskLength() {
            ...
            var pos,
                ...
                ndxIntlzr =
                    void 0 != testPos ? testPos.locator.slice() : void 0;
            for (
                pos = lvp + 1;
                void 0 == testPos ||
            ...
            return (
                ...
                void 0 == maxLength || maxLength > maskLength
                    ? maskLength
                    : maxLength
            );
        }
        ...
        function writeBuffer(
            ...
            input._valueSet(buffer.join('')),
                void 0 != caretPos && caret(input, caretPos),
                triggerInputEvent === !0 &&
                    ...
                    for (
                        ...
                        if (
                            ...
                            (null !== tests[i].match.fn ||
                                void 0 == tests[i].alternation ||
                                tests[i].locator[tests[i].alternation].length >
                                    1)
                        ) {
                            staticAlternations = !1;
                            break;
        ...
        function checkVal(input, writeOut, strict, nptvl) {
            ...
            var inputValue =
                    void 0 != nptvl
                        ? nptvl.slice()
                        : input._valueGet().split(''),
                charCodes = '',
                initialNdx = 0;
            if (
                (resetMaskSet(),
                (getMaskSet().p = seekNext(-1)),
                writeOut && input._valueSet(''),
                !strict)
            ) {
                var staticInput = getBufferTemplate()
                    ...
                    matches = inputValue
                        .join('')
                        .match(new RegExp(escapeRegex(staticInput), 'g'));
                matches &&
                    matches.length > 0 &&
        ...
        function caret(input, begin, end) {
            var range,
                npt = input.jquery && input.length > 0 ? input[0] : input;
            if ('number' != typeof begin)
                return (
                    npt.setSelectionRange
                        ? ((begin = npt.selectionStart),
                          (end = npt.selectionEnd))
                        : window.getSelection
                        ? ((range = window.getSelection().getRangeAt(0)),
                          range.commonAncestorContainer.parentNode == npt &&
                        ...
                        : document.selection &&
                          ...
                          (begin =
                              0 -
                              range.duplicate().moveStart('character', -1e5)),
            ...
            if (
                ...
                var scrollCalc =
                    $(npt).css('font-size').replace('px', '') * end;
                if (
                    ((npt.scrollLeft =
                        scrollCalc > npt.scrollWidth ? scrollCalc : 0),
                    androidchrome ||
                        0 != opts.insertMode ||
                        begin != end ||
                        end++,
                    ...
                    (npt.selectionStart = begin), (npt.selectionEnd = end);
                else if (window.getSelection) {
                    (range = document.createRange()),
                        range.setStart(
                            npt.firstChild,
                            begin < npt._valueGet().length
                                ? begin
                                : npt._valueGet().length
                        ),
                        range.setEnd(
                            npt.firstChild,
                            end < npt._valueGet().length
                                ? end
                                : npt._valueGet().length
                        ),
                        range.collapse(!0);
        ...
        function installEventRuler(npt) {
            ...
            $.each(events, function (eventType, eventHandlers) {
                $.each(eventHandlers, function (ndx, eventHandler) {
                    if (
                        'inputmask' == eventHandler.namespace &&
        ...
        function patchValueProperty(npt) {
            function PatchValhook(type) {
                if (
                    ...
                    1 != $.valHooks[type].inputmaskpatch
                ) {
                    var valhookGet =
            ...
            function setter(value) {
                ...
                valueSet.call(this, value),
                    inputData && $(this).triggerHandler('setvalue.inputmask');
            }
        ...
        function handleRemove(input, k, pos, strict) {
            ...
            if (
                (k == $.inputmask.keyCode.BACKSPACE &&
                (pos.end - pos.begin < 1 || 0 == opts.insertMode)
                    ? (pos.begin = seekPrevious(pos.begin))
                    : k == $.inputmask.keyCode.DELETE &&
                      pos.begin == pos.end &&
                      (pos.end = isMask(pos.end)
                          ? pos.end + 1
                          : seekNext(pos.end) + 1),
        ...
        function keydownEvent(e) {
            ...
            k == $.inputmask.keyCode.DELETE ||
            (iphone && 127 == k) ||
            (e.ctrlKey && 88 == k && !isInputEventSupported('cut'))
                ? (e.preventDefault(),
                  88 == k && (undoValue = getBuffer().join('')),
                  ...
                  input._valueGet() == getBufferTemplate().join('')
                      ? $input.trigger('cleared')
                      : isComplete(getBuffer()) === !0 &&
                ...
                : ((opts.undoOnEscape && k == $.inputmask.keyCode.ESCAPE) ||
                      (90 == k && e.ctrlKey)) &&
                  e.altKey !== !0
                ? (checkVal(input, !0, !1, undoValue.split('')), $input.click())
                ...
                if (valResult !== !1) {
                    if (
                        ...
                        forwardPosition =
                            !opts.keepStatic &&
                            ((void 0 != vps[p + 1] &&
                                getTests(p + 1, vps[p].locator.slice(), p)
                                    .length > 1) ||
        ...
        function pasteEvent(e) {
            ...
            if ('paste' == e.type) {
                ...
                valueBeforeCaret ==
                    ...
                    (valueBeforeCaret = ''),
                    valueAfterCaret ==
                        getBufferTemplate().slice(caretPos.end).join('') &&
                        (valueAfterCaret = ''),
        ...
        function compositionStartEvent(e) {
            ...
            (undoValue = getBuffer().join('')),
                ('' == compositionData ||
                    0 != e.originalEvent.data.indexOf(compositionData)) &&
        ...
        function mask(el) {
            if (
                ...
                opts.showTooltip && $el.prop('title', getMaskSet().mask),
            ...
            $el.unbind('.inputmask'),
                (($el.is(':input') && isInputTypeSupported($el.attr('type'))) ||
                    el.isContentEditable) &&
                    ($el
                        .closest('form')
                        .bind('submit', function (e) {
                            undoValue != getBuffer().join('') && $el.change(),
                                $el[0]._valueGet &&
                                    $el[0]._valueGet() ==
                        ...
                        .bind('mouseleave.inputmask', function () {
                            ...
                            if (opts.clearMaskOnLostFocus) {
                                var buffer = getBuffer().slice(),
                                    nptValue = input._valueGet();
                                $input.is(':focus') ||
                                    nptValue == $input.attr('placeholder') ||
                                    '' == nptValue ||
                            ...
                            if ($input.is(':focus')) {
                                ...
                                if (selectedCaret.begin == selectedCaret.end)
                                    if (
                                        ...
                                        var clickPosition = TranslatePosition(
                                                selectedCaret.begin
                                            ),
                    ...
                    androidfirefox ||
                        $el
                            .bind(
                                'compositionstart.inputmask',
                                compositionStartEvent
                            )
                            .bind(
                                'compositionupdate.inputmask',
                                compositionUpdateEvent
                            )
                            .bind(
                                'compositionend.inputmask',
                                compositionEndEvent
                            ),
                    'paste' === PasteEventType &&
                ...
                $el.bind('setvalue.inputmask', function () {
                    ...
                    input._valueSet(
                        $.isFunction(opts.onBeforeMask)
                            ? opts.onBeforeMask.call(input, value, opts) ||
                                  value
                            : value
                    ),
                        checkVal(input, !0, !1),
            ...
            var initialValue = $.isFunction(opts.onBeforeMask)
                ? opts.onBeforeMask.call(el, el._valueGet(), opts) ||
                  el._valueGet()
                : el._valueGet();
            ...
            switch (actionObj.action) {
                ...
                case 'isValid':
                    ...
                    return (
                        ...
                        isComplete(buffer) && actionObj.value == buffer.join('')
                    );
                ...
                case 'getmetadata':
                    if (
                        ...
                        return void 0 != alternation
                            ? maskset.metadata[
                                  getMaskSet().validPositions[lvp].locator[
                                      alternation
                                  ]
                              ]
                            : maskset.metadata[0];
    ...
    if (void 0 === $.fn.inputmask) {
        var ua = navigator.userAgent,
            ...
            androidchrome =
                (null !== ua.match(new RegExp('android.*safari.*', 'i')),
                null !== ua.match(new RegExp('android.*chrome.*', 'i'))),
            androidfirefox =
                null !== ua.match(new RegExp('android.*firefox.*', 'i')),
            PasteEventType =
                (/Kindle/i.test(ua) ||
                    /Silk/i.test(ua) ||
                    /KFTT/i.test(ua) ||
            ...
            ($.fn.inputmask = function (fn, options) {
                function importAttributeOptions(
                    ...
                    for (var option in opts) {
                        var optionData = $npt.data(
                            'inputmask-' + option.toLowerCase()
                        );
                        void 0 != optionData &&
                            ('mask' == option && 0 == optionData.indexOf('[')
                                ? ((opts[option] = optionData
                                  ...
                                  (opts[option][opts[option].length - 1] = opts[
                                      option
                                  ][opts[option].length - 1].replace("'", '')))
                                : (opts[option] =
                                      'boolean' == typeof optionData
                                          ? optionData
                                          : optionData.toString()),
                            importedOptionsContainer &&
                                (importedOptionsContainer[option] =
                                    opts[option]));
                    }
                    return opts;
                }
                var maskset,
                    opts = $.extend(!0, {}, $.inputmask.defaults, options);
                if ('string' == typeof fn)
                    switch (fn) {
                        case 'mask':
                            return (
                                ...
                                this.each(function () {
                                    return (
                                        ...
                                        (maskset = generateMaskSet(
                                            opts,
                                            options &&
                                                void 0 !== options.definitions
                                        )),
                                        void 0 == maskset
                                            ? this
                                            : void maskScope(
                    ...
                    if ('object' == typeof fn)
                        return (
                            (opts = $.extend(!0, {}, $.inputmask.defaults, fn)),
                    ...
                    if (void 0 == fn)
                        return this.each(function () {
                            ...
                            if (
                                $(this).attr('data-inputmask-mask') ||
                                $(this).attr('data-inputmask-alias')
                            ) {
                                opts = $.extend(
                                    !0,
                                    {},
