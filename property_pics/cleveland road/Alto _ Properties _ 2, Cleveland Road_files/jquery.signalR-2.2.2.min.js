...
(function (n, t, i) {
    ...
    var r,
        ...
        l = function (n) {
            return (
                n._.keepAliveData.activated && n.transport.supportsKeepAlive(n)
            );
        },
        p = function (i) {
            var f, e;
            i._.configuredStopReconnectingTimeout ||
                ((e = function (t) {
                    var i = r._.format(
                        r.resources.reconnectTimeout,
                        t.disconnectTimeout
                    );
                    t.log(i);
                    n(t).triggerHandler(u.onError, [
                        r._.error(i, 'TimeoutException')
                    ]);
                    t.stop(!1, !1);
                }),
                ...
                i.stateChanged(function (n) {
                    n.oldState === r.connectionState.reconnecting &&
                        t.clearTimeout(f);
                }),
    ...
    r.fn = r.prototype = {
                          ...
                          try {
                              a._.initHandler.start(
                                  ...
                                  function () {
                                      ...
                                      l(a) &&
                                          r.transports._logic.monitorKeepAlive(
                                              a
                                          );
                  ...
                  (a._.negotiateRequest = r.transports._logic.ajax(a, {
                      ...
                      success: function (t) {
                          ...
                          try {
                              ...
                              g(
                                  r._.error(f.errorParsingNegotiateResponse, c),
                                  a
                              );
                              return;
                          }
        ...
        stop: function (i, h) {
            var a = this,
                v = a._deferral;
            if (
                (a._.deferredStartHandler &&
                    e.unbind('load', a._.deferredStartHandler),
                delete a._.config,
            ...
            transportFailed: function (i, u, e) {
                ...
                this.connectionStopped ||
                    ...
                    this.startRequested
                        ? this.startCompleted ||
                          ((s = r._.error(
                              r.resources.errorDuringStartRequest,
                              u
                          )),
                          o.log(
                              i.name +
        ...
        u = r.transports._logic = {
            ...
            prepareQueryString: function (n, i) {
                ...
                return (
                    ...
                    n.data &&
                        (r +=
                            '&connectionData=' + t.encodeURIComponent(n.data)),
                    r
                );
            },
            addQs: function (t, i) {
            ...
            getUrl: function (n, i, r, f, e) {
                ...
                return (
                    !e &&
                        ...
                        (s +=
                            '&groupsToken=' +
                            t.encodeURIComponent(n.groupsToken)),
                    r
                        ? ((o += f ? '/poll' : '/reconnect'),
                          !e &&
                              n.messageId &&
                              (s +=
                                  '&messageId=' +
                                  t.encodeURIComponent(n.messageId)))
                        : (o += '/connect'),
                    (o += '?' + s),
                    ...
                    success: function (n, u, f) {
                        ...
                        try {
                            ...
                            s(
                                r._.error(
                                    r._.format(
                                        r.resources.errorParsingStartResponse,
                                        n
                                    ),
                                    o,
                                    f
                        ...
                        e.Response === 'started'
                            ...
                            : s(
                                  r._.error(
                                      r._.format(
                                          r.resources.invalidStartResponse,
                                          n
                                      ),
                                      null,
                                      f
                    ...
                    error: function (n, i, u) {
                        i !== o
                            ...
                            : (t.log(
                              ...
                              h(
                                  r._.error(
                                      r.resources.stoppedDuringStartRequest,
                                      null,
                                      n
                                  )
                              ));
            ...
            clearReconnectTimeout: function (n) {
                n &&
                    ...
                    (t.clearTimeout(n._.reconnectTimeout),
                    delete n._.reconnectTimeout);
            },
            verifyLastActive: function (t) {
                if (
                    new Date().getTime() - t._.lastActiveAt >=
                    t.reconnectWindow
                ) {
                    var i = r._.format(
                ...
                e.socket ||
                    ...
                    (e.socket.onclose = function (t) {
                        ...
                        this === e.socket &&
                            ...
                            (s && s(i)) ||
                                (i && n(e).triggerHandler(u.onError, [i]),
                                l.reconnect(e)));
                    }),
    ...
    (function (n, t) {
        ...
        i.transports.serverSentEvents = {
            ...
            start: function (o, s, h) {
                ...
                v &&
                    (o._.reconnectAttemptTimeoutHandle = t.setTimeout(
                        function () {
                            l === !1 &&
                                o.eventSource.readyState !==
                                    t.EventSource.OPEN &&
                                c.reconnect(o);
                        },
                        c.timeOut
    ...
    (function (n, t) {
        ...
        r.transports.foreverFrame = {
            ...
            receive: function (t, u) {
                var f, e, o;
                if (
                    (t.json !== t._originalJson &&
                        (u = t._originalJson.stringify(u)),
                    ...
                    t.state === n.signalR.connectionState.connected &&
                        ...
                        t.frameMessageCount >
                            ...
                            (f =
                                t.frame.contentWindow ||
                                t.frame.contentDocument),
            ...
            stop: function (n) {
                ...
                if ((f.cancel(), n.frame)) {
                    if (n.frame.stop) n.frame.stop();
                        ...
                        try {
                            r =
                                n.frame.contentWindow ||
                                n.frame.contentDocument;
                            r.document &&
        ...
        r.transports.longPolling = {
            ...
            start: function (o, s, h) {
                var a = this,
                    ...
                    y = function (n) {
                        return h(n)
                            ? (o.log('LongPolling failed to connect.'), !0)
                            : !1;
                    },
                    c = o._,
                    l = 0,
                    ...
                    w = 36e5;
                o.pollXhr &&
                    (o.log('Polling xhr requests already exists, aborting.'),
                    o.stop());
                o.messageId = null;
                c.reconnectTimeoutId = null;
                c.pollTimeoutId = t.setTimeout(function () {
                    (function e(s, h) {
                        ...
                        f(s) !== !0) &&
                            (o.log(
                                "Opening long polling request to '" + d + "'."
                            ),
                            (s.pollXhr = i.ajax(o, {
                                xhrFields: {
                                    onprogress: function () {
            ...
            stop: function (n) {
                ...
                n.pollXhr &&
                    (n.pollXhr.abort(), (n.pollXhr = null), delete n.pollXhr);
            },
            abort: function (n, t) {
                i.ajaxAbort(n, t);
            }
    ...
    (function (n) {
        ...
        function f(n, t) {
            ...
            u(i) &&
                n.log(
                    'Clearing hub invocation callbacks with error: ' + t + '.'
                );
        ...
        i.fn = i.prototype = {
            ...
            invoke: function (t) {
                ...
                return (
                    (r._.invocationCallbacks[
                        r._.invocationCallbackId.toString()
                    ] = { scope: i, method: l }),
