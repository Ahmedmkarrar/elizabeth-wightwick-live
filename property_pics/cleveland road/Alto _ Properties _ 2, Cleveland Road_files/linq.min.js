...
Enumerable = (function () {
    ...
    (c.From = function (j) {
        ...
        return new c(function () {
            ...
            return new f(
                function () {
                    for (var a in j)
                        !(j[a] instanceof Function) &&
                            b.push({ Key: a, Value: j[a] });
                },
                function () {
    ...
    c.RangeTo = function (d, e, a) {
        if (a == b) a = 1;
        return d < e
            ? c.ToInfinity(d, a).TakeWhile(function (a) {
                  return a <= e;
              })
        ...
        Zip: function (e, b) {
            ...
            return new c(function () {
                ...
                return new f(
                    ...
                    function () {
                        return i.MoveNext() && h.MoveNext()
                            ? this.Yield(b(i.Current(), h.Current(), j++))
                            : a;
                    },
                    function () {
                        try {
            ...
            return new c(function () {
                ...
                return new f(
                    ...
                    function () {
                        while (c.MoveNext())
                            return e == b
                                ? this.Yield(c.Current())
                                : this.Yield(e(c.Current().Key(), c.Current()));
                        return a;
                    },
                    function () {
                        d.Dispose(c);
        ...
        TakeWhile: function (b) {
            ...
            return new c(function () {
                ...
                return new f(
                    ...
                    function () {
                        return c.MoveNext() && b(c.Current(), g++)
                            ? this.Yield(c.Current())
                            : a;
                    },
                    function () {
    ...
    l.prototype.GenerateKeys = function (d) {
        var a = this;
        for (
            var f = d.length, g = a.keySelector, e = new Array(f), c = 0;
            c < f;
            c++
        )
            e[c] = g(d[c]);
    ...
    h.prototype.Any = function (a) {
        return a == b
            ...
            : c.prototype.Any.apply(this, arguments);
    };
    h.prototype.Count = function (a) {
        return a == b
            ? this.source.length
            : c.prototype.Count.apply(this, arguments);
    };
    h.prototype.ElementAt = function (a) {
        return 0 <= a && a < this.source.length
            ? this.source[a]
            : c.prototype.ElementAt.apply(this, arguments);
    };
    h.prototype.ElementAtOrDefault = function (a, b) {
        return 0 <= a && a < this.source.length ? this.source[a] : b;
    };
    h.prototype.First = function (a) {
        return a == b && this.source.length > 0
            ? this.source[0]
            : c.prototype.First.apply(this, arguments);
    };
    h.prototype.FirstOrDefault = function (a, d) {
        return d != b
            ? c.prototype.FirstOrDefault.apply(this, arguments)
            : this.source.length > 0
            ? this.source[0]
            : a;
    };
    h.prototype.Last = function (d) {
        var a = this;
        return d == b && a.source.length > 0
            ? a.source[a.source.length - 1]
            : c.prototype.Last.apply(a, arguments);
    };
    h.prototype.LastOrDefault = function (d, e) {
        var a = this;
        return e != b
            ? c.prototype.LastOrDefault.apply(a, arguments)
            : a.source.length > 0
            ? a.source[a.source.length - 1]
            : d;
    };
    ...
    h.prototype.SequenceEqual = function (d, e) {
        return (d instanceof h || d instanceof Array) &&
            e == b &&
            c.From(d).Count() != this.Count()
            ? a
            : c.prototype.SequenceEqual.apply(this, arguments);
    };
