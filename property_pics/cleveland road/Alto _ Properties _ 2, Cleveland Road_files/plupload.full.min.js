    ...
    i(u, [], function () {
                ...
                i = (function () {
                    var t = {
                        ...
                        use_data_uri_over32kb: function () {
                            return (
                                t.use_data_uri &&
                                ('IE' !== r.browser || r.version >= 9)
                            );
                        },
                        use_data_uri_of: function (e) {
                            return (
                                (t.use_data_uri && 33e3 > e) ||
                                t.use_data_uri_over32kb()
                            );
                        },
            ...
            function i(o, a) {
                ...
                n.call(this),
                    ...
                    e.extend(this, {
                        ...
                        isDetached: function () {
                            return (
                                !this.ruid && 'string' === e.typeOf(r[this.uid])
                            );
                        },
                        destroy: function () {
            ...
            function c(r) {
                ...
                (p = {
                    ...
                    'string' == typeof r.accept &&
                        (r.accept = t.mimes2extList(r.accept)),
                    (d = n.get(r.container)),
                    d || (d = document.body),
        ...
        i(_, [c, f, p, u, w, v, h, l], function (e, t, n, i, r, o, a, s) {
            function u(n) {
                ...
                'string' == typeof n && (n = { drop_zone: n }),
                    ...
                    'string' == typeof n.accept &&
                        (n.accept = s.mimes2extList(n.accept)),
                    o.call(a),
                    i.extend(a, {
                        uid: i.guid('uid_'),
                        ruid: null,
                        ...
                        (this.result = null),
                            -1 ===
                                ...
                                c &&
                                    c
                                        .getRuntime()
                                        .exec.call(this, 'FileReader', 'abort'),
                                this.trigger('abort'),
                    ...
                    destroy: function () {
                        this.abort(),
                            c &&
                                (c
                                    .getRuntime()
                                    .exec.call(this, 'FileReader', 'destroy'),
                                c.disconnectRuntime()),
                            (o = c = null);
                    }
                });
                ...
                function p() {
                    ...
                    function u(t) {
                        ...
                        (M = new Date().getTime()),
                            ...
                            t instanceof c &&
                                (P.required_caps.send_multipart = !0),
                    ...
                    e.extend(this, y, {
                        ...
                        open: function (o, a, s, u, c) {
                            ...
                            (A = !w),
                                ...
                                this.convertEventPropsToHandlers([
                                    'readystatechange'
                                ]),
                        ...
                        getResponseHeader: function (t) {
                            return (
                                (t = t.toLowerCase()),
                                N ||
                                ~e.inArray(t, ['set-cookie', 'set-cookie2'])
                                    ? null
                                    : U &&
                                      '' !== U &&
                                      (B ||
                        ...
                        overrideMimeType: function (i) {
                            var r, o;
                            if (
                                ~e.inArray(n('readyState'), [p.LOADING, p.DONE])
                            )
                                throw new t.DOMException(
                                    t.DOMException.INVALID_STATE_ERR
                                );
                        ...
                        abort: function () {
                            if (
                                ...
                                k
                                    .getRuntime()
                                    .exec.call(k, 'XMLHttpRequest', 'abort', D),
                                    (D = !0);
                            }
                        },
                        destroy: function () {
                            k &&
                                ('function' === e.typeOf(k.destroy) &&
                                    k.destroy(),
                                (k = null)),
                                this.unbindAll(),
                                this.upload &&
                            ...
                            if (t instanceof p) {
                                if (!t.size)
                                    throw new n.DOMException(
                                        n.DOMException.INVALID_STATE_ERR
                                    );
                                ...
                                if (
                                    ...
                                    throw new n.DOMException(
                                        n.DOMException.TYPE_MISMATCH_ERR
                                    );
                    ...
                    a.call(this),
                        e.extend(this, {
                            ...
                            downsize: function (t, i, r, o) {
                                try {
                                    ...
                                    if (
                                        ...
                                        throw new n.ImageError(
                                            n.ImageError.MAX_RESOLUTION_ERR
                                        );
                                    ((!t && !i) ||
                            ...
                            getAsCanvas: function () {
                                if (!u.can('create_canvas'))
                                    throw new n.RuntimeError(
                                        n.RuntimeError.NOT_SUPPORTED_ERR
                                    );
                            ...
                            getAsBinaryString: function (e, t) {
                                ...
                                return f.atob(
                                    n.substring(n.indexOf('base64,') + 7)
                                );
                            },
                            embed: function (i) {
                                function r() {
        ...
        i(L, [u], function (e) {
            ...
            var i = {},
                ...
                a = function (t, n, o) {
                    var a, s;
                    if (
                        ((n = n.toLowerCase()), t[r] && i[t[r]] && i[t[r]][n])
                    ) {
                        a = i[t[r]][n];
                        for (
                            var u = a.length - 1;
                    ...
                    init: function (s) {
                        ...
                        (a = s),
                            ...
                            (d.innerHTML =
                                ...
                                (a.multiple && c.can('select_multiple')
                                    ? 'multiple'
                                    : '') +
                            ...
                            c.can('summon_file_dialog') &&
                                ...
                                (h =
                                    parseInt(n.getStyle(p, 'z-index'), 10) ||
                                    1),
                                (p.style.zIndex = h),
                                (d.style.zIndex = h - 1),
                                i.addEvent(
                ...
                if (((r = new e()), r.init(n), 65496 === r.SHORT(0))) {
                    ...
                    return (
                        r.init(null),
                        {
                            ...
                            get: function (e) {
                                for (
                                    var t = [], n = 0, r = i.length;
                                    r > n;
                                    n++
                                )
                                    i[n].name === e.toUpperCase() &&
                                        t.push(i[n].segment);
                                return t;
                            },
                            set: function (e, t) {
                ...
                function i(e, n) {
                    ...
                    for (r = 0; i > r; r++)
                        if (
                            ...
                            (h = 1 == d ? m[0] : m),
                                (g[s] =
                                    l.hasOwnProperty(s) && 'object' != typeof h
                                        ? l[s][h]
                                        : h);
                        }
                    return g;
                    ...
                    return (
                        ...
                        42 !== a.SHORT((e += 2))
                            ...
                            : ((c.IFD0 = c.tiffHeader + a.LONG((e += 2))),
                              ...
                              'ExifIFDPointer' in u &&
                                  ((c.exifIFD =
                                      c.tiffHeader + u.ExifIFDPointer),
                                  delete u.ExifIFDPointer),
                              'GPSInfoIFDPointer' in u &&
                                  ((c.gpsIFD =
                                      c.tiffHeader + u.GPSInfoIFDPointer),
                ...
                (s = i),
                    ...
                    (function () {
                        ...
                        for (n = 0; n < i.length; n++, t += 2)
                            if (i[n] != u.SHORT(t))
                                throw new e.ImageError(
                                    e.ImageError.WRONG_FORMAT
                                );
                    })(),
                    (d = r.call(this)),
                    t.extend(this, {
        ...
        i(q, [], function () {
            function e(e, i, r) {
                ...
                p.width = p.height = f;
                for (
                    var h = p.getContext('2d'), m = n(e, o, a), g = 0;
                    a > g;
            ...
            function c() {
                    ...
                    (y = new Image()),
                        (y.onerror = function () {
                            g.call(this),
                                t.trigger(
                                    'error',
                                    new n.ImageError(n.ImageError.WRONG_FORMAT)
                                );
                        }),
                        (y.onload = function () {
                            t.trigger('load');
                        }),
                        (y.src = /^data:[^;]*;base64,/.test(e)
                            ? e
                            : l(e, x.type));
                }
                function f(e, t) {
                        ...
                        ? ((r = new FileReader()),
                          ...
                          (r.onerror = function () {
                              i.trigger(
                                  'error',
                                  new n.FileException(
                                      n.FileException.NOT_READABLE_ERR
                                  )
                              );
                          }),
                          r.readAsDataURL(e),
                ...
                t.extend(this, {
                    ...
                    getAsBlob: function (e, t) {
                        return (
                            e !== this.type &&
                                p.call(this, this.width, this.height, !1),
                            new r(null, {
                                name: x.name || '',
                                type: e,
    ...
    o.addFileFilter('mime_types', function (e, t, n) {
        ...
        o.addFileFilter('prevent_duplicates', function (e, t, n) {
            if (e) {
                ...
                while (r--)
                    if (
                        t.name === this.files[r].name &&
                        t.size === this.files[r].size
                    ) {
                        this.trigger('Error', {
        ...
        (o.Uploader = function (e) {
            ...
            function b() {
                ...
                d.size === n
                    ? (d.percent =
                          f.length > 0
                              ? Math.ceil((d.uploaded / f.length) * 100)
                              : 0)
                    ...
                    switch (e) {
                        ...
                        case 'filters':
                            o.typeOf(t) === 'array' && (t = { mime_types: t }),
                                ...
                                t.mime_types &&
                                    (a.filters.mime_types.regexp = (function (
                                        e
                                    ) {
                                        var t = [];
                                        return (
                        ...
                        case 'resize':
                            n
                                ? o.extend(a.resize, t, { enabled: !0 })
                                : (a.resize = t);
                            break;
                        case 'prevent_duplicates':
                            a.prevent_duplicates =
                                a.filters.prevent_duplicates = !!t;
                            break;
                        case 'browse_button':
                        case 'drop_element':
                            t = o.get(t);
        ...
        (o.File = (function () {
            function n(n) {
                o.extend(this, {
                    ...
                    status: o.QUEUED,
                    lastModifiedDate:
                        n.lastModifiedDate || new Date().toLocaleString(),
                    getNative: function () {
                        var e = this.getSource().getSource();
                        return t.inArray(t.typeOf(e), ['blob', 'file']) !== -1
                            ? e
                            : null;
                    },
                    getSource: function () {
