!(function (t) {
    ...
    function e(t) {
        return '[object StopIteration]' === en(t) || t instanceof _;
    }
    function r(t, n) {
        if (
            V &&
    ...
    function a() {
        ...
        var n,
            ...
            i = Z(h.prototype);
        if (
            ((i.promiseDispatch = function (t, o, i) {
                var u = L(arguments);
                e
                    ? (e.push(u), 'when' === o && i[1] && r.push(i[1]))
                    : p.nextTick(function () {
    ...
    function h(t, n, e) {
        ...
        var r = Z(h.prototype);
        if (
            ((r.promiseDispatch = function (e, o, i) {
                var u;
                try {
    ...
    function b() {
        (on.length = 0), (un.length = 0), sn || (sn = !0);
    }
    function x(t, n) {
        sn &&
            ('object' == typeof process &&
                ...
                p.nextTick.runAfter(function () {
                    -1 !== X(un, t) &&
                        (process.emit('unhandledRejection', n, t), cn.push(t));
                }),
            un.push(t),
            on.push(
                n && 'undefined' != typeof n.stack ? n.stack : '(no stack) ' + n
            ));
    }
    function T(t) {
        if (sn) {
            ...
            -1 !== n &&
                ('object' == typeof process &&
                    ...
                    p.nextTick.runAfter(function () {
                        var e = X(cn, t);
                        -1 !== e &&
                            (process.emit('rejectionHandled', on[n], t),
                            cn.splice(e, 1));
                    }),
                un.splice(n, 1),
                on.splice(n, 1));
        ...
        return y(t, function (t) {
            ...
            return (
                W(
                    ...
                    function (r, o, i) {
                        var u;
                        m(o) && 'fulfilled' === (u = o.inspect()).state
                            ? (t[i] = u.value)
                            : (++n,
                              y(
                                  o,
        ...
        J = (function () {
            ...
            function n(n, e) {
                try {
                    ...
                    if (u)
                        throw (
                            (e && e.exit(), setTimeout(t, 0), e && e.enter(), r)
                        );
                    setTimeout(function () {
                        throw r;
                    }, 0);
            ...
            if (
                ((J = function (t) {
                    (r = r.next =
                        { task: t, domain: u && process.domain, next: null }),
                        o || ((o = !0), i());
                }),
                'object' == typeof process &&
    ...
    (p.resolve = p),
        ...
        (a.prototype.makeNodeResolver = function () {
            ...
            return function (n, e) {
                n
                    ? t.reject(n)
                    : t.resolve(arguments.length > 2 ? L(arguments, 1) : e);
            };
        }),
        (p.Promise = l),
        (p.promise = l),
    ...
    (p.resetUnhandledRejections = b),
        ...
        (h.prototype.mapply = h.prototype.post =
            function (t, n) {
        ...
        (h.prototype.fail = h.prototype['catch'] =
            function (t) {
        ...
        (h.prototype.fin = h.prototype['finally'] =
            function (t) {
                return (
                    (t = p(t)),
                    this.then(
        ...
        (h.prototype.timeout = function (t, n) {
            var e = a(),
                r = setTimeout(function () {
                    (n && 'string' != typeof n) ||
                        ((n = new Error(n || 'Timed out after ' + t + ' ms')),
                        (n.code = 'ETIMEDOUT')),
                        e.reject(n);
                }, t);
            return (
        ...
        (h.prototype.nfbind = h.prototype.denodeify =
            function () {
                var t = L(arguments);
        ...
        (h.prototype.nmapply = h.prototype.npost =
            function (t, n) {
                var e = L(n || []),
                    r = a();
                return (
